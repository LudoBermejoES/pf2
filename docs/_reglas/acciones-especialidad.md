...
| [Montar]({{ '/reglas/acciones-especialidad/montar/' | relative_url }}) | {% include accion.html tipo="1" %} | Rasgos:, * Movimiento, Requisitos: | ** Estas adyacente a una criatura por lo menos un tamaño mayor que tu, que esta dispuesta a dejarse montar. |
| [Senalar]({{ '/reglas/acciones-especialidad/senalar/' | relative_url }}) | {% include accion.html tipo="1" %} | Rasgos:, * Auditivo, Manipular, Visual, Requisitos: | ** Una criatura no ha sido detectada por uno o mas de tus aliados, pero si por ti. |
| [Volar]({{ '/reglas/acciones-especialidad/volar/' | relative_url }}) | {% include accion.html tipo="1" %} | Rasgos:, * Movimiento, Requisitos: | ** Tienes Velocidad de vuelo |
