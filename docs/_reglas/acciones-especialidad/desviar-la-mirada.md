...
<img src="{{ '/assets/images/acciones/desviar-la-mirada.png' | relative_url }}" style="float: right; width: 150px; margin-left: 15px; margin-bottom: 10px;" alt="Carta de acción">
