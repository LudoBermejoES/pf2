...
| Tamaño | Espacio | Alcance (alta) | Alcance (larga) |
|--------|---------|----------------|-----------------|
...
El terreno difícil es cualquier terreno que obstaculiza el movimiento, lo que va desde superficies particularmente agrestes o inestables hasta una cubierta vegetal espesa e incontables otros impedimentos. Entrar en una casilla de terreno difícil (o mover 5 pies [1,5 m] hacia un area de terreno difícil o por el interior de la misma, si no utilizas un tablero) cuesta 5 pies (1,5 m) de movimiento adicionales. Mover a una casilla de terreno difícil mayor cuesta 10 pies (3 m) de movimiento adicionales. Este coste adicional no se incrementa cuando se mueve en diagonal. No puedes dar un Paso en terreno difícil.

El movimiento que haces cuando saltas ignora el terreno sobre el que saltas. Algunas aptitudes (como por ejemplo volar o ser incorporal) te permiten evitar la reducción de movimiento debida a algunos tipos de terreno difícil.

## Terreno difícil mayor

El terreno difícil mayor funciona igual que el terreno difícil, pero cuesta 10 pies (3 m) de movimiento adicionales en lugar de 5 pies (1,5 m).

## Ignorar el terreno difícil

Algunas aptitudes te permiten ignorar el terreno difícil. En dicho caso, puedes tambien atravesar el terreno difícil mayor pagando el coste adicional de movimiento que impone normalmente el terreno difícil. Una aptitud no te permitira ignorar por completo el terreno difícil mayor a menos que la aptitud especifique lo contrario.
...
- Casilla con terreno difícil: +5 pies (1,5 m) adicionales
- Diagonal par con terreno difícil: 15 pies (4,5 m)
