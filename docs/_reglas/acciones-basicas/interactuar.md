---
layout: page
permalink: /reglas/acciones-basicas/interactuar/
title: Interactuar
chapter: Cómo Jugar
category: reglas
source: PC1
...
<img src="{{ '/assets/images/acciones/interactuar.png' | relative_url }}" style="float: right; width: 150px; margin-left: 15px; margin-bottom: 10px;" alt="Carta de acción">
