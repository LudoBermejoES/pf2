---
layout: page
permalink: /clases/investigador/builds/investigador-forense/
title: Investigador Forense
parent: Investigador
category: builds
source: PC2
tags: [forense, medicina, anatomía, precisión]
recommended: false
adventure_path: null
---
...
- **Mano Principal**: [Estoque]({{ '/equipo/armas/estoque/' | relative_url }}) o [Espada corta]({{ '/equipo/armas/espada-corta/' | relative_url }}) (perforante/cortante)
- **Secundaria**: [Daga]({{ '/equipo/armas/daga/' | relative_url }})

## Habilidades Importantes

- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — esencial para metodología
- [Sociedad]({{ '/habilidades/sociedad/' | relative_url }}) — investigación urbana
- [Artesanía]({{ '/habilidades/artesania/' | relative_url }}) — análisis de evidencia
...
- Usar Medicina para Recordar Conocimiento sobre criaturas
- Bonificador de investigación a pruebas de Medicina

### Punta del Escalpelo
- Requiere éxito crítico
- Daño cortante o perforante
- 1d6 sangrado persistente

### Shock Quirúrgico
| Resultado | Efecto |
|-----------|--------|
| Éxito crítico | Torpe 3 o estupefacto 3 |
| Éxito | Torpe 2 o estupefacto 2 |
| Fallo | +1 circunstancia siguiente ataque |
...
- Debuffs potentes con Medicina
- Información sobre anatomía enemiga
- Excelente para investigar escenas de crimen
