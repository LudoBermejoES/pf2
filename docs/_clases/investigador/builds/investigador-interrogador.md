---
layout: page
permalink: /clases/investigador/builds/investigador-interrogador/
title: Investigador Interrogador
parent: Investigador
category: builds
source: PC2
tags: [interrogatorio, social, intimidación, información]
recommended: false
adventure_path: null
---
...
| **Metodología** | Interrogatorio |

## Armas

- **Mano Principal**: [Maza]({{ '/equipo/armas/maza/' | relative_url }}) o [Bastón]({{ '/equipo/armas/baston/' | relative_url }}) (no letal)
- **Secundaria**: Arma de reserva

## Habilidades Importantes

- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — esencial para metodología
- [Engaño]({{ '/habilidades/engano/' | relative_url }}) — manipulación
- [Diplomacia]({{ '/habilidades/diplomacia/' | relative_url }}) — persuasión
...
### Solo Una Cosa Más
- Desencadenante: Fallas prueba social
- Efecto: Reroll con doble bonificador de investigación
- Funciona con Desmoralizar, Fintar, Mentir, etc.
...
- Extrae información sin magia
- Combina social con combate (miedo)
- Capturas vivas para interrogar

### Debilidades
- Menos efectivo vs inmunes al miedo
- Requiere que haya alguien que interrogar
- Menos útil en mazmorras sin NPCs
