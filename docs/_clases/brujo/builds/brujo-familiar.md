---
layout: page
permalink: /clases/brujo/builds/brujo-familiar/
title: Brujo del Familiar
parent: Brujo
category: builds
source: PC2
tags: [familiar, vínculo, espíritu, compañero]
recommended: false
adventure_path: null
---
...
- **Arma Principal**: Familiar como arma

## Habilidades Importantes

- [Ocultismo]({{ '/habilidades/ocultismo/' | relative_url }}) o según tradición
- [Naturaleza]({{ '/habilidades/naturaleza/' | relative_url }}) — cuidado del familiar
- [Arcano]({{ '/habilidades/arcano/' | relative_url }}) — conocimiento mágico
...
**De Amo:**
- Familiar: Te entrega objetos
- Lanzador de conjuros: Entrega conjuros de toque
- Contenedor de conjuros: Almacena un conjuro

**De Familiar:**
- Volador: Vuela
- Hablador: Habla idiomas
- Resistente: Más PG
...
- Muchas aptitudes útiles
- Excelente acción económica
- Drenaje recupera recursos

### Debilidades
- Familiar puede morir
- Ataques de familiar son 1/10 min
- Depende del familiar para máximo poder
