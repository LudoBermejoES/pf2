---
layout: page
permalink: /clases/brujo/builds/brujo-maleficio/
title: Brujo de Maleficios
parent: Brujo
category: builds
source: PC2
tags: [maleficios, maldiciones, debuff, control]
recommended: false
adventure_path: null
---
...
| **Patrón** | Cualquiera (Ocultista recomendado para maleficios mentales) |

## Armas

- **Arma Principal**: [Daga]({{ '/equipo/armas/daga/' | relative_url }}) o bastón

## Habilidades Importantes

- [Ocultismo]({{ '/habilidades/ocultismo/' | relative_url }}) — tradición recomendada
...
### Tipos de Lecciones
**Lecciones Básicas:**
- Maleficios de debuff menor
- Conjuros de utilidad

**Lecciones Mayores:**
- Maleficios más potentes
- Efectos de control

**Lecciones Superiores:**
- Maleficios devastadores
- Efectos de área o duración larga
...
### Fortalezas
- Muchos maleficios diferentes
- Debuffs sostenidos con risotada
- Excelente control de encuentros
- Maestría total a nivel 20

### Debilidades
- Requiere acciones para mantener
- Maleficios son de concentración
- Menos daño directo
- Necesita múltiples turnos para acumular

---


[← Volver a Brujo]({{ '/clases/brujo/' | relative_url }})
