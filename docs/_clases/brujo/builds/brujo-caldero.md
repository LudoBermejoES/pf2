---
layout: page
permalink: /clases/brujo/builds/brujo-caldero/
title: Brujo del Caldero
parent: Brujo
category: builds
source: PC2
tags: [caldero, pociones, elaboración, soporte]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Carisma (+3), Constitución (+2) |
| **Patrón** | Cualquiera (Arcano o Primigenio recomendado) |
...
- [Artesanía]({{ '/habilidades/artesania/' | relative_url }}) — elaboración de pociones
- [Ocultismo]({{ '/habilidades/ocultismo/' | relative_url }}) o [Naturaleza]({{ '/habilidades/naturaleza/' | relative_url }}) — según tradición
- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — conocimiento de brebajes
...
- Poción de velocidad (acelerado)
- Poción de invisibilidad
- Poción de vuelo
- Poción de resistencia elemental
...
- Maleficios en forma de poción
- Excelente soporte de equipo
- Versatilidad con pociones preparadas

### Debilidades
- Menos ofensivo directamente
- Pociones requieren acción para usar
- Depende de preparación
- Pociones temporales duran solo 1 día
