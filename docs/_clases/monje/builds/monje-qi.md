---
layout: page
permalink: /clases/monje/builds/monje-qi/
title: Monje del Qi
parent: Monje
category: builds
source: PC2
tags: [qi, hechizos, versatilidad]
recommended: false
adventure_path: null
---
...
| Elemento | Elección |
|----------|----------|
| **Atributo Clave** | Fuerza (+3) o Destreza (+3) |
| **Atributos Secundarios** | Sabiduría (+3), Constitución (+2) |
| **Enfoque** | Hechizos de Qi |

## Armas

- **Ataques Desarmados**: Puños o ataques de postura

## Habilidades Importantes

- [Acrobacia]({{ '/habilidades/acrobacia/' | relative_url }}) — movimiento y evasión
- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — maniobras de combate
- [Ocultismo]({{ '/habilidades/ocultismo/' | relative_url }}) — conocimiento místico
...
- Ataques a distancia sin armas
- Movilidad excepcional

### Debilidades
- Depende de Puntos de Concentración
- Menos daño bruto que builds de postura pura
- Requiere gestionar múltiples recursos
