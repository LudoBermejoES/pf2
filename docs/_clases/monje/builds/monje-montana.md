---
layout: page
permalink: /clases/monje/builds/monje-montana/
title: Monje de la Montaña
parent: Monje
category: builds
source: PC2
tags: [montaña, defensa, tanque, inamovible]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Constitución (+3), Sabiduría (+2) |
| **Enfoque** | Postura de la Montaña |

## Armas

- **Ataques Desarmados**: Piedra cayendo (1d8 contundente, contundente)

## Habilidades Importantes

- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — maniobras y resistir empujes
- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — presencia imponente
- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — autocuidado
...
El Monje de la Montaña es el tanque definitivo sin armadura:
...
- Excelente control con agarres
- Tanque efectivo sin armadura

### Debilidades
- Velocidad reducida en 1,5m
- Límite de DES a CA (+0, luego +1, +2)
- Menos daño ofensivo
- Torpe en espacios grandes
