---
layout: page
permalink: /clases/alquimista/builds/alquimista-bombardero/
title: Alquimista Bombardero
parent: Alquimista
category: builds
source: PC2
tags: [bombardero, bombas, daño, área]
recommended: false
adventure_path: null
---
...
- **Arma Principal**: Bombas alquímicas
- **Secundaria**: Ballesta ligera (backup)

## Habilidades Importantes

- [Artesanía]({{ '/habilidades/artesania/' | relative_url }}) — crear bombas y alquimia
- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — soporte de equipo
- [Sociedad]({{ '/habilidades/sociedad/' | relative_url }}) — conocimiento general
...
| Bomba | Daño | Efecto |
|-------|------|--------|
| Fuego de alquimista | Fuego | Persistente |
| Frasco de ácido | Ácido | Persistente |
| Relámpago embotellado | Electricidad | Desprevenido |
| Bomba de escarcha | Frío | Penalizador velocidad |
...
- Radio aumenta a 3m
- +INT al daño de salpicadura
- Con descubrimiento de bombardero: 2x INT a salpicadura
...
### Debilidades
- Recursos limitados (bombas/día)
- Menos efectivo 1v1
- Cuidado con el fuego amigo
- Requiere preparación diaria
