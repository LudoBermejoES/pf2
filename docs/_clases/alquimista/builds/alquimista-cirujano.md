---
layout: page
permalink: /clases/alquimista/builds/alquimista-cirujano/
title: Alquimista Cirujano
parent: Alquimista
category: builds
source: PC2
tags: [cirujano, curación, soporte, elixires]
recommended: false
adventure_path: null
---
...
| **Campo de Investigación** | Cirujano |

## Armas

- **Arma Principal**: [Ballesta]({{ '/equipo/armas/ballesta/' | relative_url }}) o arma simple
- **Secundaria**: Elixires lanzables

## Habilidades Importantes

- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — esencial para curación
- [Artesanía]({{ '/habilidades/artesania/' | relative_url }}) — crear elixires
- [Naturaleza]({{ '/habilidades/naturaleza/' | relative_url }}) — conocimiento de antídotos
...
- Remueve condiciones sin magia
- Curación a distancia con bombas
- Resucita a nivel alto

### Debilidades
- Menos ofensivo que otros builds
- Depende de recursos preparados
- Curación requiere acciones del objetivo
- No puede auto-administrar elixires fácilmente en combate
