...
<div class="feat-traits-header" markdown="0"><a href="/rasgos/alquimista/" class="feat-trait">Alquimista</a></div>
...
Ademas, si realizas un Golpe de cerbatana mientras estas oculto o sin detectar, no te vuelves observado automaticamente. En su lugar, intenta inmediatamente una prueba de Sigilo contra la CD de Percepcion del objetivo. Si tienes exito, no te vuelves observado, y estas oculto (si no estabas detectado, aun te vuelves oculto en lugar de permanecer sin detectar).
...
Los quimicos curativos en tus viales versatiles tambien ayudan a calmar la mente del paciente. Cuando una criatura viviente afectada por un efecto mental recupera Puntos de Golpe de uno de tus viales versatiles, puede intentar inmediatamente una nueva tirada de salvacion de Voluntad para terminar un efecto mental de su eleccion. Obtiene un bonificador de objeto +1 a la tirada de salvacion.
...
<div class="feat-traits-header" markdown="0"><a href="/rasgos/alquimista/" class="feat-trait">Alquimista</a><a href="/rasgos/concentrar/" class="feat-trait">Concentrar</a><a href="/rasgos/manipular/" class="feat-trait">Manipular</a></div>
...
Reunes suficientes ingredientes de lo que queda en tu juego de herramientas de alquimista para producir algunos viales versatiles mas sobre la marcha. Intenta una prueba de Artesania. La CD suele ser una CD de dificultad estandar para tu nivel, pero el DJ puede asignar una CD diferente segun las circunstancias. El numero de viales que recuperas depende del resultado de tu prueba (hasta tu maximo).

**Exito critico** Recuperas 3 viales versatiles.

**Exito** Recuperas 2 viales versatiles.

**Fallo** Recuperas 1 vial versatil.

**Fallo critico** No recuperas ningun vial versatil.

---

### Veneno Pernicioso · Dote 2

<div class="feat-traits-header" markdown="0"><a href="/rasgos/aditivo/" class="feat-trait">Aditivo</a><a href="/rasgos/alquimista/" class="feat-trait">Alquimista</a></div>
...
<div class="feat-traits-header" markdown="0"><a href="/rasgos/alquimista/" class="feat-trait">Alquimista</a><a href="/rasgos/concentrar/" class="feat-trait">Concentrar</a></div>

**Requisitos:** Estas bajo los efectos de un mutageno.

Metabolizas un mutageno para curarte. Recuperas 1d6 Puntos de Golpe por cada 2 niveles de objeto del mutageno requerido (minimo 1d6 PG), pero la duracion del mutageno termina inmediatamente.
...
Ademas, cuando elaboras consumibles alquimicos durante el tiempo de inactividad, puedes producir el doble de objetos alquimicos en un solo lote sin gastar tiempo preparatorio adicional. Por ejemplo, si estas creando elixires de vida, puedes elaborar hasta ocho elixires en un solo lote usando tiempo de inactividad, en lugar de cuatro. Esto no cambia la cantidad de reactivos alquimicos u otros ingredientes requeridos para elaborar cada objeto, ni cambia tu ritmo de progreso para los dias posteriores al tiempo de inactividad base gastado.
...
**Fallo** El objetivo recupera PG iguales al numero de dados de dano del elixir.

**Fallo critico** La bomba curativa no tiene efecto.
...
Redireccionas un mutageno dentro de tu cuerpo para escupir un chorro de acido estomacal a un enemigo. Una criatura dentro de 9 metros recibe 1d6 de dano de acido por cada 2 niveles que tengas, con una tirada de salvacion de Reflejos basica contra tu CD de clase. En un fallo, la criatura tambien tiene nauseas 1 (o nauseas 2 en un fallo critico). La duracion del mutageno termina inmediatamente.
...
**Especial** Si tienes la dote Salpicadura Expandida u otra capacidad que aumente el radio del dano de salpicadura, puedes hacer que el dano de salpicadura sea un cono de 6 metros.
...
<div class="feat-traits-header" markdown="0"><a href="/rasgos/alquimista/" class="feat-trait">Alquimista</a><a href="/rasgos/exploracion/" class="feat-trait">Exploracion</a></div>

**Requisitos:** Estas sosteniendo o vistiendo un juego de herramientas de alquimista.

A veces, necesitas adaptar tus mezclas alquimicas a nuevas situaciones. En un proceso que toma 10 minutos, cambias un objeto que creaste con alquimia avanzada a un objeto similar. Puedes cambiar una bomba alquimica a otro tipo de bomba alquimica, un elixir a otro tipo de elixir, o un veneno a otro tipo de veneno. Si no esta claro si dos consumibles alquimicos son similares, el DJ decide. Debes conocer la formula para el nuevo objeto, y el nuevo objeto debe ser del mismo nivel de objeto o inferior al objeto original. El nuevo objeto aun mantiene el rasgo imbuido, y permanece potente mientras el objeto original lo hubiera sido.
...
**Especial** Puedes seleccionar esta dote una segunda vez para elegir un tipo diferente de vigorizacion y anadir sus opciones a las que puedes elegir.
...
**Especial** Si puedes estar bajo los efectos de multiples mutagenos (con el descubrimiento de campo mayor del mutagenicista, por ejemplo), obtienes todos los beneficios relevantes.
...
Haces un lote aun mas grande de objetos alquimicos cada manana. Aumenta el numero maximo de objetos que puedes crear con alquimia avanzada a 8 + tu modificador de Inteligencia, o a 10 + tu modificador de Inteligencia si eres de nivel 16 o superior.
...
Has aprendido tecnicas mejoradas y secretos alquimicos que te permiten expandir el rango de efectos que puedes imponer con tus bombas. Cuando usas Bomba Debilitante, anade lo siguiente a la lista de la que puedes elegir: torpe 1, debilitado 1, estupefacto 1, o penalizacion de estado de -3 metros a las Velocidades.
...
- **Mutageno Sereno** Los efectos de deteccion, revelacion y escrutinio de rango 9 (o nivel 17) o inferior no detectan nada de ti o tus posesiones y auras. Por ejemplo, detectar magia aun detectaria otra magia en el area, pero no cualquier magia sobre ti.
- **Mutageno Lengua de Plata** Ignora las penalizaciones de circunstancia que recibirias a las pruebas de Engano, Diplomacia, Intimidacion y Actuacion. Ademas, tus palabras trascienden las barreras linguisticas; todos los que te escuchan hablar oyen tus palabras como si estuvieras hablando en su propio idioma (aunque en realidad no hablas ese idioma, ni esta capacidad te permite entender idiomas adicionales).
...
Tu cuerpo acepta y retiene facilmente cambios menores. Cuando bebes uno de tus objetos alquimicos que tiene los rasgos elixir e imbuido y una duracion de 1 minuto o mas, puedes hacer que la duracion del elixir sea indefinida. Puedes hacerlo solo si el nivel del elixir es la mitad de tu nivel o inferior. Si luego consumes un elixir diferente y lo haces indefinido, el efecto del elixir indefinido anterior termina.
...
Has entrenado tu forma fisica para permanecer estable. Una vez por dia, cuando consumes un objeto alquimico con los rasgos imbuido y mutageno, puedes extender su duracion para que dure hasta la proxima vez que hagas tus preparaciones diarias en lugar de su duracion normal. A diferencia de la extension normal de Extender Elixir, esto puede exceder la duracion de un objeto creado con Alquimia Rapida mas alla de su limite normal de 10 minutos.
...
Tu maestria alquimica puede resucitar a los recien fallecidos. Puedes administrar un elixir de vida mayor o verdadero a una criatura que ha estado muerta por no mas de 2 asaltos. Cuando lo haces, esa criatura vuelve inmediatamente a la vida con 1 Punto de Golpe y se vuelve herido 1.
...
<div class="feat-traits-header" markdown="0"><a href="/rasgos/aditivo/" class="feat-trait">Aditivo</a><a href="/rasgos/alquimista/" class="feat-trait">Alquimista</a><a href="/rasgos/manipular/" class="feat-trait">Manipular</a></div>
