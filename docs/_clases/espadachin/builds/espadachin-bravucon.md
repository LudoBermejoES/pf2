---
layout: page
permalink: /clases/espadachin/builds/espadachin-bravucon/
title: Espadachín Bravucón
parent: Espadachín
category: builds
source: PC2
tags: [intimidación, miedo, desmoralizar, social]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Carisma (+4), Constitución (+1) |
| **Estilo** | Bravucón |

## Armas

- **Mano Principal**: [Estoque]({{ '/equipo/armas/estoque/' | relative_url }}) o [Espada ancha]({{ '/equipo/armas/espada-ancha/' | relative_url }})
- **Mano Secundaria**: Libre (para gestos dramáticos)

## Habilidades Importantes

- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — esencial para Desmoralizar
- [Engaño]({{ '/habilidades/engano/' | relative_url }}) — fintas y trucos
- [Diplomacia]({{ '/habilidades/diplomacia/' | relative_url }}) — presencia social
...
### Fortalezas
- Excelente debuff de equipo
- Control psicológico del combate
- Útil dentro y fuera de combate
- Hace enemigos más fáciles para todos

### Debilidades
- Inefectivo contra inmunes al miedo
- Requiere inversión en Carisma
- Menos movilidad que otros estilos

---


[← Volver a Espadachín]({{ '/clases/espadachin/' | relative_url }})
