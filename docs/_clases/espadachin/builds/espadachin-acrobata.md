---
layout: page
permalink: /clases/espadachin/builds/espadachin-acrobata/
title: Espadachín Acróbata
parent: Espadachín
category: builds
source: PC2
tags: [acróbata, movilidad, rodar, gimnasta]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Carisma (+3), Fuerza (+1) |
| **Estilo** | Gimnasta |

## Armas

- **Mano Principal**: [Espada corta]({{ '/equipo/armas/espada-corta/' | relative_url }}) o doble arma ligera
- **Mano Secundaria**: Segunda arma o libre

## Habilidades Importantes

- [Acrobacia]({{ '/habilidades/acrobacia/' | relative_url }}) — esencial para Rodar a través
- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — saltos y trepar
- [Interpretación]({{ '/habilidades/interpretacion/' | relative_url }}) — fanfarronadas con estilo
...
- CD de saltos -10
- Salto vertical hasta 1,5m / horizontal hasta 6m

### Fortalezas
- Movilidad incomparable
- Fácil acceso a desprevenido
- Difícil de atrapar o flanquear
- Excelente para terreno vertical

### Debilidades
- Menos defensa estática
- Depende de pruebas de Acrobacia
- Vulnerable si está inmovilizado
