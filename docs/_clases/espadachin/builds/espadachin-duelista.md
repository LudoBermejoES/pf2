---
layout: page
permalink: /clases/espadachin/builds/espadachin-duelista/
title: Espadachín Duelista
parent: Espadachín
category: builds
source: PC2
tags: [duelista, riposte, defensa, panache]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Carisma (+3), Constitución (+1) |
| **Estilo** | Fanfarrón |

## Armas

- **Mano Principal**: [Estoque]({{ '/equipo/armas/estoque/' | relative_url }}) o [Espada ropera]({{ '/equipo/armas/espada-ropera/' | relative_url }})
- **Mano Secundaria**: Libre (para paradas)

## Habilidades Importantes

- [Engaño]({{ '/habilidades/engano/' | relative_url }}) — fintas y fanfarronadas
...
### Fortalezas
- Excelente en duelos 1v1
- Muchas reacciones defensivas
- Contraataques constantes
- Difícil de matar

### Debilidades
- Menos efectivo contra grupos
- Depende de que enemigos fallen
- Requiere mano libre para máxima defensa
