---
layout: page
permalink: /clases/picaro/builds/granuja-callejero/
title: Granuja Callejero (Fintero)
parent: Pícaro
category: builds
source: PC1
tags: [fintas, engaño, control]
recommended: false
adventure_path: null
---
...
| Elemento | Elección |
|----------|----------|
| **Atributo Clave** | Carisma (+3) o Destreza (+3) |
...
- **Segunda Mano**: Libre (para Fintas) o daga

## Habilidades Importantes

- [Engaño]({{ '/habilidades/engano/' | relative_url }}) — esencial para Fintas
...
El enredo de Granuja te permite usar Carisma como atributo clave y enfatiza las Fintas. Obtienes Finta como entrenamiento y tu Golpe debilitante obtiene opciones adicionales.
...
### Fortalezas
- Excelente control de un solo objetivo
- Funciona en combate y fuera de él
- Muy bueno negando acciones enemigas
- Alto Carisma útil socialmente

### Debilidades
- Menos daño directo que el Ladrón
- Depende de pruebas de habilidad
- Enemigos inmunes a miedo reducen efectividad
