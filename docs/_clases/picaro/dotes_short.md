...
| [Buscador de Trampas]({{ '/dotes/picaro/buscador-de-trampas/'| relative_url }}) | Una intuición te da un pequeño bono para detectar y evitar trampas. | Picaro | — |
| [Esquiva Agil]({{ '/dotes/picaro/esquiva-agil/'| relative_url }}) | Logras +2 circunstancial a la CA contra el ataque que activó tu reacción. | Picaro | No estas impedido. |
| [Finta Excesiva]({{ '/dotes/picaro/finta-excesiva/'| relative_url }}) | Tu finta amplia las opciones de éxito crítico y éxito normal sobre tu adversario. | Picaro | Entrenado en Engano |
...
| [Brazo Fuerte]({{ '/dotes/picaro/brazo-fuerte/'| relative_url }}) | Extiendes el alcance de tus armas arrojadizas por 10 pies más al atacar. | Picaro | — |
| [Desenvainado Rapido]({{ '/dotes/picaro/desenvainado-rapido/'| relative_url }}) | Desenfundas y atacas en la misma acción, manteniendo ritmo ofensivo. | Picaro | — |
| [Finta Distractora]({{ '/dotes/picaro/finta-distractora/'| relative_url }}) | Tus fintas distraen aún más, haciendo que la criatura sufra penalización adicional. | Picaro | Enredo de granuja |
| [Gambito Astuto]({{ '/dotes/picaro/gambito-astuto/'| relative_url }}) | Usas tu movimiento para evaluar al enemigo y generar una ventaja táctica inmediata. | Picaro | Enredo de mente maestra |
...
| [Aviso del Batidor]({{ '/dotes/picaro/aviso-del-batidor/'| relative_url }}) | Alertas a los aliados con un aviso literal para darles sino un bono situacional. | Picaro | — |
| [Distracción Gemela]({{ '/dotes/picaro/distraccion-gemela/'| relative_url }}) | Tus ataques con dos armas confunden tanto que el adversario pierde el control. | Picaro | Finta gemela |
| [Envenenar Arma]({{ '/dotes/picaro/envenenar-arma/'| relative_url }}) | Aplicas un veneno durante un ataque siempre que puedas manipular y el arma esté lista. | Manipular | Estas empuñando una arma. |
| [Mas Dura Sera la Caída]({{ '/dotes/picaro/mas-dura-sera-la-caida/'| relative_url }}) | Haces que el derribo inflija daño adicional a la víctima en caída. | Picaro | — |
| [Pegador Temible]({{ '/dotes/picaro/pegador-temible/'| relative_url }}) | Los críticos aterrados te permiten continuar golpeando a enemigos asustados desprevenidos. | Picaro | — |
| [Persecucion Reactiva]({{ '/dotes/picaro/persecucion-reactiva/'| relative_url }}) | Mantienes el ritmo con un enemigo que huye, terminando el movimiento junto a él. | Picaro | — |
| [Pisoton en la Cabeza]({{ '/dotes/picaro/pisoton-en-la-cabeza/'| relative_url }}) | Castigas a quien cae con un golpe que lo deja anonadado un turno. | Picaro | — |
...
| [Andate con Ojo]({{ '/dotes/picaro/andate-con-ojo/'| relative_url }}) | Intimidas y atraes la atención del enemigo para que se preocupe por ti. | Emocion | Rango entrenado en Intimidación |
| [Anticipar Emboscada]({{ '/dotes/picaro/anticipar-emboscada/'| relative_url }}) | Te mantienes alerta durante un viaje lento para detectar emboscadas antes de que te alcancen. | Exploración | Rango experto en Sigilo |
| [Desarme Taimado]({{ '/dotes/picaro/desarme-taimado/'| relative_url }}) | Usas Latrocinio para desarmar sin depender de Fuerza. | Picaro | — |
| [Echar Abajo]({{ '/dotes/picaro/echar-abajo/'| relative_url }}) | Haces palanca para derribar al enemigo aunque esté fuera de tu alcance inicial. | Picaro | Rango entrenado en Atletismo |
| [Golpe Hostigador]({{ '/dotes/picaro/golpe-hostigador/'| relative_url }}) | Combinas movimiento y ataque para golpear y retirarte en secuencia. | Floritura | — |
| [Lanzamiento Lejano]({{ '/dotes/picaro/lanzamiento-lejano/'| relative_url }}) | Apenas sufres penalización extra por cada incremento de rango con armas arrojadizas. | Picaro | — |
...
| [Diana]({{ '/dotes/picaro/diana/'| relative_url }}) | Tu próximo disparo con arma arrojadiza ignora ocultamiento y cobertura ligera. | Picaro | — |
| [Entrada Tactica]({{ '/dotes/picaro/entrada-tactica/'| relative_url }}) | Das una Zancada sin provocar reacciones durante el movimiento de entrada. | Picaro | Rango maestro en Sigilo. |
| [Envenenar Arma Mejorado]({{ '/dotes/picaro/envenenar-arma-mejorado/'| relative_url }}) | Los venenos infligen más daño y efectos cuando los aplicas con esta dote. | Picaro | Envenenar arma |
| [Estratagema Inspirada]({{ '/dotes/picaro/estratagema-inspirada/'| relative_url }}) | Compartes tus planes diarios con hasta cinco aliados para avisarles luego en combate. | Picaro | — |
| [Llevarte un Recuerdo]({{ '/dotes/picaro/llevarte-un-recuerdo/'| relative_url }}) | Robas algo del enemigo mientras te escabulles de su alcance. | Picaro | Estas apresado o neutralizado por una criatura. |
| [Lucha a Ciegas]({{ '/dotes/picaro/lucha-a-ciegas/'| relative_url }}) | Detectas enemigos ocultos sin necesidad de éxito en la prueba inicial. | Picaro | Rango maestro en Percepción. |
| [Paso Lateral]({{ '/dotes/picaro/paso-lateral/'| relative_url }}) | Rediriges un ataque hacia otra criatura moviéndote lateralmente. | Picaro | — |
| [Pegador Astuto]({{ '/dotes/picaro/pegador-astuto/'| relative_url }}) | Tus golpes son eficientes incluso contra enemigos que no están desprevenidos. | Picaro | Ataque furtivo |
| [Posición de Rebote]({{ '/dotes/picaro/posicion-de-rebote/'| relative_url }}) | Tu posición hace que las armas arrojadizas reboten de vuelta hacia ti para nuevos ataques. | Picaro | — |
...
| [Debilitaciones Crueles]({{ '/dotes/picaro/debilitaciones-crueles/'| relative_url }}) | Tus debilitaciones añaden efectos severos que perjudican a tus enemigos. | Picaro | Enredo de rufian, Golpe debilitante |
| [Debilitaciones Metodicas]({{ '/dotes/picaro/debilitaciones-metodicas/'| relative_url }}) | Eliges debilitaciones para negar ventajas tácticas específicas del enemigo. | Picaro | Enredo de mente maestra, Golpe debilitante |
...
| [Debilitacion Sangrienta]({{ '/dotes/picaro/debilitacion-sangrienta/'| relative_url }}) | Tus golpes provocan sangrado con nuevas opciones de debilitación. | Picaro | Entrenado en Medicina, Golpe debilitante |
| [Disparo Derribador]({{ '/dotes/picaro/disparo-derribador/'| relative_url }}) | Tu tiro a distancia derriba a enemigos voladores no preparados. | Picaro | — |
| [Finta de Rebote]({{ '/dotes/picaro/finta-de-rebote/'| relative_url }}) | Rebota un arma arrojadiza para distraer mientras haces una finta. | Picaro | Posición de rebote |
| [Interferencia Reactiva]({{ '/dotes/picaro/interferencia-reactiva/'| relative_url }}) | Creas un obstáculo inmediato que obliga al enemigo a fallar su reacción. | Picaro | — |
...
| [Dejar una Abertura]({{ '/dotes/picaro/dejar-una-abertura/'| relative_url }}) | Tus críticos crean oportunidades para que un aliado te siga con un ataque. | Picaro | — |
...
| [Eludir Rapidamente]({{ '/dotes/picaro/eludir-rapidamente/'| relative_url }}) | Te desplazas y evitas ataques con una prueba de Acrobacias exitosa. | Picaro | Rango legendario en Acrobacias |
| [Pisada Nubosa]({{ '/dotes/picaro/pisada-nubosa/'| relative_url }}) | Caminas por superficies inestables sin perder el equilibrio. | Picaro | Rango legendario en Acrobacias |
| [Pizarra en Blanco]({{ '/dotes/picaro/pizarra-en-blanco/'| relative_url }}) | Evitas efectos mágicos de detección y escudriñamiento con tu engaño. | Picaro | Rango legendario en Engano |
