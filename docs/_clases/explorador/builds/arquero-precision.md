---
layout: page
permalink: /clases/explorador/builds/arquero-precision/
title: Arquero de Precisión
parent: Explorador
category: builds
source: PC1
tags: [distancia, daño, precisión]
recommended: false
adventure_path: null
---
...
- **Mano Principal**: [Arco largo compuesto]({{ '/equipo/armas/arco-largo-compuesto/' | relative_url }}) o [Arco largo]({{ '/equipo/armas/arco-largo/' | relative_url }})
- **Arma Secundaria**: Daga (última emergencia)

## Habilidades Importantes

- [Sigilo]({{ '/habilidades/sigilo/' | relative_url }}) — posicionamiento
- [Percepción]({{ '/habilidades/percepcion/' | relative_url }}) — detectar enemigos
...
- Depende de tener línea de visión
- Un solo objetivo por turno (por Precisión)
