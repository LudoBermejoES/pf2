---
layout: page
permalink: /clases/explorador/builds/duelista-doble-arma/
title: Duelista de Doble Arma
parent: Explorador
category: builds
source: PC1
tags: [cuerpo a cuerpo, doble arma, floritura]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Fuerza (+2), Constitución (+2) |
| **Ventaja del Cazador** | Flanqueador |

## Armas

- **Mano Principal**: [Espada corta]({{ '/equipo/armas/espada-corta/' | relative_url }}) o [Kukri]({{ '/equipo/armas/kukri/' | relative_url }})
- **Mano Secundaria**: [Espada corta]({{ '/equipo/armas/espada-corta/' | relative_url }}) o [Daga]({{ '/equipo/armas/daga/' | relative_url }})
...
La ventaja de Flanqueador te permite flanquear a tu presa incluso sin un aliado en posición. Cuando Persigues presa, la presa siempre está desprevenida contra ti como si la estuvieras flanqueando.
...
- Daño combinado atraviesa resistencias
- Excelentes reacciones defensivas
- No necesita aliados para flanquear

### Debilidades
- Alcance limitado (cuerpo a cuerpo)
- Penalizador por ataque múltiple acumulativo
- Menos daño por golpe que armas de dos manos
