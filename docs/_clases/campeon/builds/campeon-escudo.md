---
layout: page
permalink: /clases/campeon/builds/campeon-escudo/
title: Campeón del Escudo
parent: Campeón
category: builds
source: PC2
tags: [tanque, escudo, protector]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Constitución (+4), Carisma (+1) |
| **Causa** | Justicia |

## Armas

- **Mano Principal**: [Espada bastarda]({{ '/equipo/armas/espada-bastarda/' | relative_url }}) o [Martillo de guerra]({{ '/equipo/armas/martillo-de-guerra/' | relative_url }})
- **Mano Secundaria**: [Escudo de torre]({{ '/equipo/armas/escudo-de-torre/' | relative_url }}) o [Escudo pesado]({{ '/equipo/armas/escudo-pesado/' | relative_url }})

## Habilidades Importantes

- [Religión]({{ '/habilidades/religion/' | relative_url }}) — tradición divina
- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — maniobras defensivas
- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — curar fuera de combate
...
La causa de Justicia te da el Golpe Retributivo como reacción. Cuando un enemigo daña a un aliado, puedes golpear a ese enemigo y tu aliado obtiene resistencia al daño.
...
- Múltiples reacciones defensivas
- Protege activamente a aliados
- Control de zona efectivo

### Debilidades
- Daño moderado
- Depende del escudo (vulnerabilidad a destrucción)
- Requiere estar en cuerpo a cuerpo
