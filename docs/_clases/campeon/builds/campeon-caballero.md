---
layout: page
permalink: /clases/campeon/builds/campeon-caballero/
title: Caballero Montado
parent: Campeón
category: builds
source: PC2
tags: [montura, movilidad, carga]
recommended: false
adventure_path: null
---
...
| Elemento | Elección |
|----------|----------|
| **Atributo Clave** | Fuerza (+3) |
| **Atributos Secundarios** | Constitución (+2), Carisma (+3) |
| **Causa** | Grandeza |

## Armas

- **Mano Principal**: [Lanza de caballería]({{ '/equipo/armas/lanza-de-caballeria/' | relative_url }}) o [Lanza]({{ '/equipo/armas/lanza/' | relative_url }})
- **Mano Secundaria**: [Escudo pesado]({{ '/equipo/armas/escudo-pesado/' | relative_url }})

## Habilidades Importantes

- [Religión]({{ '/habilidades/religion/' | relative_url }}) — tradición divina
- [Naturaleza]({{ '/habilidades/naturaleza/' | relative_url }}) — cuidado de la montura
- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — maniobras montado
- [Diplomacia]({{ '/habilidades/diplomacia/' | relative_url }}) — presencia noble
...
La causa de Grandeza te da Destello de Grandeza como reacción. Cuando un aliado recibe daño, reduces el daño y el atacante queda cegado.
...
- **Caballo**: Clásico y eficiente para cargas
- **Lobo gigante**: Más agresivo, derriba enemigos
...
5. Reposiciona con movilidad de la montura

### Fortalezas
- Excelente movilidad
- Daño de carga devastador
- Montura celestial con vuelo
- Protección móvil del grupo

### Debilidades
- Espacios reducidos limitan la montura
- Requiere gestionar montura y campeón
- Montura puede ser atacada separadamente
