---
layout: page
permalink: /clases/campeon/builds/campeon-profano/
title: Campeón Profano
parent: Campeón
category: builds
source: PC2
tags: [profano, ofensivo, venganza]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Constitución (+2), Carisma (+2) |
| **Causa** | Iniquidad o Profanación |

## Armas

- **Mano Principal**: [Espadón]({{ '/equipo/armas/espadon/' | relative_url }}) o [Guadaña]({{ '/equipo/armas/guadana/' | relative_url }})
- **Mano Secundaria**: Libre o [Escudo pesado]({{ '/equipo/armas/escudo-pesado/' | relative_url }})

## Habilidades Importantes

- [Religión]({{ '/habilidades/religion/' | relative_url }}) — tradición divina
- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — presencia aterradora
- [Engaño]({{ '/habilidades/engano/' | relative_url }}) — manipulación
- [Ocultismo]({{ '/habilidades/ocultismo/' | relative_url }}) — conocimiento oscuro
...
### Iniquidad
Venganza Destructiva te permite dañar a enemigos que te atacan, dañándote a ti mismo en el proceso pero infligiendo más daño al enemigo.

### Profanación
Escudo Egoísta te protege de ataques, priorizando tu propia supervivencia sobre la de aliados.
...
### Fortalezas
- Alto daño sostenido
- Debilita enemigos con condiciones
- Aura aterradora
- Daño profano efectivo contra extrasagrados

### Debilidades
- Menos protección de aliados que campeones extrasagrados
- Autoinflige daño con algunas reacciones
- Anatemas restrictivos de deidades malvadas

---


[← Volver a Campeón]({{ '/clases/campeon/' | relative_url }})
