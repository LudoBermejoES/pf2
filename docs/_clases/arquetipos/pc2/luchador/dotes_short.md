...
El arquetipo de Luchador te otorga acceso a nuevas habilidades y talentos especializados. Debes cumplir todos los requisitos antes de seleccionar una dote.
...
|------|-------------|--------|------------|
| [Dedicación de Luchador](/dotes/arquetipo/luchador/dedicacion-de-luchador/) | Tu entrenamiento en las artes de la lucha te hace especia... | Arquetipo, Dedicación | entrenado en Atletismo |
...
| Dote | Descripción | Rasgos | Requisitos |
|------|-------------|--------|------------|
| [Agarre ineludible](/dotes/arquetipo/luchador/agarre-ineludible/) | Tu agarre tiene una cualidad sobrenatural que impide que ... | Arquetipo | Dedicación de Luchador |
