---
layout: page
permalink: /clases/arquetipos/otros/petimetre/
title: Petimetre
chapter: Clases
category: clases
source: PC2
...
Eres un refinado maestro del estilo, la cultura y el decoro, consciente incluso de las reglas más sutiles de la etiqueta.
...
**Desencadenante:** Observas que la actitud de un objetivo hacia ti o tus aliados disminuye como resultado del comportamiento de un aliado.

Sabes mantener una buena impresión y gestionar tu imagen incluso en compañía poco refinada. Haz una prueba de Engaño contra la CD de Voluntad del objetivo. Independientemente de tu resultado, el objetivo es temporalmente inmune a tu Halago distractor durante 10 minutos.

**Éxito:** La actitud del objetivo no disminuye como resultado del desliz social de tu aliado.

**Fallo:** La actitud del objetivo disminuye como es normal.

**Fallo crítico:** Tu intento empeora las cosas, disminuyendo la actitud del objetivo hacia ti en un paso, además de cualquier cambio por el comportamiento que desencadenó esta reacción.
...
Si tienes competencia legendaria en Sociedad, obtienes competencia experta en Saber de chismes, pero no puedes aumentar tu rango de competencia en Saber de chismes por otros medios.
...
Asistes a todas las fiestas de la alta sociedad, por muy exclusivas que sean. Cada vez que te encuentres con un evento social al que normalmente te denegarían el acceso, como una coronación, una gala real u otra función, puedes dedicar de 1 a 4 horas para conseguir entrar sin necesidad de una prueba de habilidad. Encuentras invitaciones, invitados que buscan citas elegantes, trabajos temporales con los caterings, personal del evento dispuesto a mirar hacia otro lado u otro modo de acceso para ti y tus aliados. Esta capacidad no se aplica a eventos secretos u otras pequeñas reuniones privadas sin personal, citas ni externos implicados.
