...
| [Conjuro de Alcance]({{ '/dotes/clerigo/conjuro-de-alcance/' | relative_url }}) | Puedes ampliar el alcance de tus conjuros. | Clérigo | — |
| [Iniciado de un Dominio]({{ '/dotes/clerigo/iniciado-de-un-dominio/' | relative_url }}) | Tu dios te concede un conjuro especial relacionado con sus poderes. | Clérigo | — |
| [Manos Curativas]({{ '/dotes/clerigo/manos-curativas/' | relative_url }}) | Tu vitalidad es aun mas vibrante y restablecedora. | Clérigo | Fuente curativa |
...
| [Asustar a los Muertos]({{ '/dotes/clerigo/asustar-a-los-muertos/' | relative_url }}) | La vitalidad desata el terror en los muertos vivientes. | Clérigo | — |
...
| [Estampar Armamento]({{ '/dotes/clerigo/estampar-armamento/' | relative_url }}) | Grabando con cuidado una imagen sagrada en un objeto fisico, te refuerzas para la batalla. | Clérigo | — |
| [Expansion de Truco]({{ '/dotes/clerigo/expansion-de-truco/' | relative_url }}) | Estudias una gama mas amplia de conjuros sencillos. | Clérigo | — |
...
| [Canalizacion Dirigida]({{ '/dotes/clerigo/canalizacion-dirigida/' | relative_url }}) | Puedes moldear en una sola dirección la energia que canalizas. | Clérigo | — |
| [Canalizar Castigo]({{ '/dotes/clerigo/canalizar-castigo/' | relative_url }}) | Absorbes las energias de la vida y de la muerte mediante un ataque cuerpo a cuerpo contra un enemigo. | Clérigo | — |
...
| [Derribar]({{ '/dotes/clerigo/derribar/' | relative_url }}) | La fuerza bruta de tu fe puede hacer que un enemigo caiga al suelo. | Clérigo | — |
| [Energia Selectiva]({{ '/dotes/clerigo/energia-selectiva/' | relative_url }}) | Al llamar al poder divino, puedes evitar que algunos enemigos se beneficien de ello o que algunos aliados resulten dañados. | Clérigo | — |
...
| [Dominio Avanzado]({{ '/dotes/clerigo/dominio-avanzado/' | relative_url }}) | Tus plegarias han desbloqueado secretos mas profundos del dominio de tu dios. | Clérigo | Iniciado de un dominio |
| [Estampar Energia]({{ '/dotes/clerigo/estampar-energia/' | relative_url }}) | Con las fuerzas elementales, haces que tus símbolos estampados sean mas potentes. | Clérigo | Estampar armamento |
| [Foco Emergente]({{ '/dotes/clerigo/foco-emergente/' | relative_url }}) | Cuando un aliado al que puedes ver cae en combate, tu oleada de justa indignación te permite recurrir a reservas sin usar de poder divino. | Clérigo | — |
| [Incinerar Muertos Vivientes]({{ '/dotes/clerigo/incinerar-muertos-vivientes/' | relative_url }}) | Tu abrumadora vitalidad prende fuego a los muertos vivientes. | Clérigo | — |
| [Martir]({{ '/dotes/clerigo/martir/' | relative_url }}) | Haces esfuerzos extremos para apoyar a tus aliados, incluso si ello significa dañarte a ti mismo. | Clérigo | — |
...
| [Arma Castigadora]({{ '/dotes/clerigo/arma-castigadora/' | relative_url }}) | La fuerza del castigo de tu dios refuerza tu cuerpo para abatir al enemigo y a sus aliados. | Clérigo | Castigo divino |
...
| [Estampar Antimagia]({{ '/dotes/clerigo/estampar-antimagia/' | relative_url }}) | El simbolo de tu dios te protege contra la magia ofensiva. | Clérigo | Estampar armamento |
| [Foco de Dominio]({{ '/dotes/clerigo/foco-de-dominio/' | relative_url }}) | Tu devoción al dominio de tu dios sigue creciendo, igual que el poder que te concede. | Clérigo | — |
...
| [Bloqueo de Canalizacion]({{ '/dotes/clerigo/bloqueo-de-canalizacion/' | relative_url }}) | Viertes energia divina en un bloqueo desesperado. | Clérigo | Bloqueo con el escudo |
| [Canalizacion Rapida]({{ '/dotes/clerigo/canalizacion-rapida/' | relative_url }}) | El poder divino esta siempre a tu alcance, respondiendo rapidamente a tu llamada. | Clérigo | fuente dañina o fuente curativa |
| [Destierro Rapido]({{ '/dotes/clerigo/destierro-rapido/' | relative_url }}) | La fuerza de tu golpe envia a tu victima de vuelta a su Plano de origen. | Clérigo | Tienes preparado un conjuro de destierro. |
...
| [Bendicion Eterna]({{ '/dotes/clerigo/bendicion-eterna/' | relative_url }}) | Tus buenas obras te han granjeado la gracia de tu dios para toda la eternidad. | Clérigo | sagrado |
...
| [Canalizacion Resonante]({{ '/dotes/clerigo/canalizacion-resonante/' | relative_url }}) | Cuando utilizas vitalidad o energia del dacio, tambien creas una pequeña reserva de dicha energia. | Clérigo | — |
| [Claridad Compartida]({{ '/dotes/clerigo/claridad-compartida/' | relative_url }}) | Puedes proyectar tus premoniciones de claridad a tus aliados. | Clérigo | Premonicion de claridad |
