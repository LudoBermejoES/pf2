---
layout: page
permalink: /clases/clerigo/builds/sanador-enclaustrado/
title: Clérigo Sanador (Enclaustrado)
parent: Clérigo
category: builds
source: PC1
tags: [sanación, apoyo, lanzador]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Carisma (+2), Constitución (+2) |
| **Doctrina** | Clérigo Enclaustrado |
| **Deidad** | Sarenrae, Farasma o Shelyn |
| **Dominio** | Curación, Familia o Protección |

## Armas

- **Arma**: Bastón o arma favorita de la deidad (uso mínimo)
...
**Obligatorio** para esta configuración. Obtienes conjuros de curar adicionales iguales a 1 + tu modificador de Carisma.

---

## Estilo de Juego

El Clérigo Sanador es el mejor sanador del juego:
...
- Muchos conjuros de curar gratuitos
- Puede eliminar estados negativos
- Excelente fuera de combate con Medicina

### Debilidades
- Muy poco daño ofensivo
- Vulnerable en combate cuerpo a cuerpo
- Depende de que el grupo le proteja
