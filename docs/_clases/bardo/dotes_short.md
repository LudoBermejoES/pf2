...
| [Composición Persistente]({{ '/dotes/bardo/composicion-persistente/' | relative_url }}) | Tus composiciones duran más; aprendes el conjuro de foco *composición persistente*. | Bardo | musa maestro |
| [Conjuro de Alcance]({{ '/dotes/bardo/conjuro-de-alcance/' | relative_url }}) | Aumentas el alcance del conjuro siguiente que lances en 30 pies cuando lo lanzas como acción. | Bardo | — |
| [Himno de Curación]({{ '/dotes/bardo/himno-de-curacion/' | relative_url }}) | Obtienes el conjuro de foco *himno de curación* para recuperar aliados con música sana. | Bardo | — |
...
| [Canción de Fuerza]({{ '/dotes/bardo/cancion-de-fuerza/' | relative_url }}) | Obtienes el truco de foco *canción de fuerza* para reforzar el vigor físico de tus aliados. | Bardo | musa combatiente |
| [Empujón Emocional]({{ '/dotes/bardo/empujon-emocional/' | relative_url }}) | Un cambio emocional repentino te da ventaja inmediata sobre el siguiente ataque. | Bardo | — |
| [Estudio del Maestro del Saber]({{ '/dotes/bardo/estudio-del-maestro-del-saber/' | relative_url }}) | Aprendes el truco *estudio del maestro del saber* para desenterrar conocimientos ocultos. | Bardo | musa enigma |
| [Expansión de Truco]({{ '/dotes/bardo/expansion-de-truco/' | relative_url }}) | Añades dos trucos extra de tu lista para tener curas rápidas adicionales. | Bardo | — |
...
| [Avance Valeroso]({{ '/dotes/bardo/avance-valeroso/' | relative_url }}) | Un grito potente impulsa a un aliado a moverse y atacar gracias al himno valeroso. | Auditivo | musa combatiente |
| [Conjuro Melodioso]({{ '/dotes/bardo/conjuro-melodioso/' | relative_url }}) | Entrelazas tus conjuros con música para que el siguiente gane el rasgo melodioso. | Bardo | — |
| [Himno de Reagrupamiento]({{ '/dotes/bardo/himno-de-reagrupamiento/' | relative_url }}) | Obtienes el truco *himno de reagrupamiento* que protege a tus aliados. | Bardo | — |
| [Investigador Ritual]({{ '/dotes/bardo/investigador-ritual/' | relative_url }}) | Ganas +2 cuando investigas rituales gracias a una técnica refinada. | Poco común | musa enigma, rango experto en ocultismo |
...
| [Canción de Marcha]({{ '/dotes/bardo/cancion-de-marcha/' | relative_url }}) | Obtienes el truco *canción de marcha* para cubrir grandes distancias sin esfuerzo. | Bardo | — |
| [Conocimiento Asegurado]({{ '/dotes/bardo/conocimiento-asegurado/' | relative_url }}) | Recordar conocimiento siempre te arroja un resultado muy fiable, incluso en otras habilidades. | Bardo | musa enigma |
| [Coordinación Defensiva]({{ '/dotes/bardo/coordinacion-defensiva/' | relative_url }}) | Tu próxima composición puede proteger a aliados como si todos contaran con un himno defensivo. | Auditivo | musa combatiente, Himno de Reagrupamiento |
...
| [Composición Fortísima]({{ '/dotes/bardo/composicion-fortissima/' | relative_url }}) | Aprendes el conjuro de foco *moldeo de conjuros* para hacer más potentes tus himnos. | Bardo | musa maestro |
| [Habilidad Ecléctica]({{ '/dotes/bardo/habilidad-eclectica/' | relative_url }}) | Obtienes tu bono por competencia en habilidades no entrenadas y habilidades aprendidas. | Bardo | musa polifacético, rango maestro en Ocultismo |
| [Llamada y Respuesta]({{ '/dotes/bardo/llamada-y-respuesta/' | relative_url }}) | Tus aliados continúan la interpretación sin perder el ritmo cuando usas el formato de llamada y respuesta. | Auditivo | — |
...
| [Anotar Composición]({{ '/dotes/bardo/anotar-composicion/' | relative_url }}) | Documentas una composición para que otros puedan leerla y activarla como inspiración. | Bardo | — |
| [Composición Inusual]({{ '/dotes/bardo/composicion-inusual/' | relative_url }}) | Tomas una composición auditiva o visual y la transformas en otro tipo de expresión igual de poderosa. | Bardo | musa polifacético |
| [La Casa de los Muros Imaginarios]({{ '/dotes/bardo/la-casa-de-los-muros-imaginarios/' | relative_url }}) | Creas una barrera ilusoria realista con la ayuda del truco de composición homónimo. | Bardo | — |
...
| [Conocimiento del Enigma]({{ '/dotes/bardo/conocimiento-del-enigma/' | relative_url }}) | Ganas los efectos de *conocimiento automático* sin gastar acciones extras. | Bardo | Conocimiento asegurado |
...
| [Balada Tranquilizadora]({{ '/dotes/bardo/balada-tranquilizadora/' | relative_url }}) | Aprendes *balada tranquilizadora* para calmar heridas y dar alivio. | Bardo | — |
| [Gusano Auditivo]({{ '/dotes/bardo/gusano-auditivo/' | relative_url }}) | Repetir un motivo causa que la melodía se quede en la mente de tus aliados para inspirar varias veces. | Bardo | — |
...
| [Polifacético Imposible]({{ '/dotes/bardo/polifacetico-imposible/' | relative_url }}) | Accedes a conjuros de tradiciones distintas gracias a tu formación esotérica. | Bardo | entrenado en Arcanos, Naturaleza o Religión, Polifacético esotérico |
...
| [Bis Perfecto]({{ '/dotes/bardo/bis-perfecto/' | relative_url }}) | Recuperas un espacio de conjuro de 10.º nivel adicional como si compusieras otra obra maestra. | Bardo | Obra maestra |
