---
layout: page
permalink: /clases/bardo/builds/bardo-combatiente/
title: Bardo Combatiente
parent: Bardo
category: builds
source: PC1
tags: [cuerpo a cuerpo, marcial, apoyo]
recommended: false
adventure_path: null
---
...
| Elemento | Elección |
|----------|----------|
| **Atributo Clave** | Carisma (+3) |
| **Atributos Secundarios** | Destreza (+3), Constitución (+2) |
| **Musa** | Combatiente |

## Armas

- **Mano Principal**: [Estoque]({{ '/equipo/armas/estoque/' | relative_url }}) o [Espada ropera]({{ '/equipo/armas/espada-ropera/' | relative_url }})
- **Mano Secundaria**: Escudo ligero o libre para gestos

## Habilidades Importantes

- [Interpretación]({{ '/habilidades/interpretacion/' | relative_url }}) — composiciones
- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — maniobras de combate
- [Acrobacias]({{ '/habilidades/acrobacias/' | relative_url }}) — posicionamiento
- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — presencia en batalla
...
La musa combatiente te inspira a mezclar armas y música. Obtienes Interpretación Marcial y acceso a dotes que mejoran tus composiciones en combate cuerpo a cuerpo.
...
- **Himno valeroso**: Bonificador a ataques, se extiende al dañar
- **Canción de fuerza**: Para maniobras de combate
- **Himno de reagrupamiento**: Cuando necesitas defensa
...
- Composiciones se mantienen mientras luchas
- Excelentes reacciones en combate
- PG temporales y bonificadores para todo el grupo

### Debilidades
- Menos robusto que guerreros puros
- Requiere estar en cuerpo a cuerpo para maximizar
- Gestionar composiciones y ataques es complejo
