---
layout: page
permalink: /clases/oraculo/builds/oraculo-llamas/
title: Oráculo de las Llamas
parent: Oráculo
category: builds
source: PC2
tags: [llamas, fuego, daño, destrucción]
recommended: false
adventure_path: null
---
...
- **Mano Principal**: Arma simple (rara vez usada)

## Habilidades Importantes

- [Religión]({{ '/habilidades/religion/' | relative_url }}) — conocimiento divino
- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — presencia ardiente
- [Naturaleza]({{ '/habilidades/naturaleza/' | relative_url }}) — conocimiento elemental
...
- 2d6 fuego al final de cada turno (4d6 en vinculado 3+)
- No puedes excluirte
- Dura 1 minuto
- Puedes suprimirlo temporalmente

### Conjuros de Fuego Recomendados
- Producir llama (truco)
- Manos ardientes
- Bola de fuego
- Muro de fuego
- Tormenta de fuego
