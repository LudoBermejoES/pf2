---
layout: page
permalink: /clases/oraculo/builds/oraculo-batalla/
title: Oráculo de Batalla
parent: Oráculo
category: builds
source: PC2
tags: [batalla, combate, marcial, maldición]
recommended: false
adventure_path: null
---
...
- **Mano Principal**: Arma marcial de tu deidad o [Espada larga]({{ '/equipo/armas/espada-larga/' | relative_url }})
- **Armadura**: Armadura intermedia

## Habilidades Importantes

- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — combate marcial
...
- Invoca aliados fantasmales
- Buff de equipo con iniciativa
- Versátil entre conjuros y ataques

### Debilidades
- Menos conjuros que oráculo puro
- Maldición puede ser peligrosa
- Dividido entre estadísticas
