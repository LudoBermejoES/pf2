---
layout: page
permalink: /clases/druida/builds/druida-tormenta/
title: Druida de la Tormenta
parent: Druida
category: builds
source: PC1
tags: [daño, electricidad, área]
recommended: false
adventure_path: null
---
...
| Elemento | Elección |
|----------|----------|
| **Atributo Clave** | Sabiduría (+4) |
| **Atributos Secundarios** | Constitución (+2), Destreza (+2) |
| **Orden Druídica** | Orden de la Tormenta |

## Armas

- **Mano Principal**: [Bastón]({{ '/equipo/armas/baston/' | relative_url }}) (componente de conjuros)
...
La orden de la tormenta te conecta con el poder del clima y los elementos atmosféricos. Obtienes resistencia a electricidad y el conjuro de orden *oleada de tempestad*.

### Conjuro de Orden: Oleada de Tempestad

Una ráfaga de viento y electricidad que daña y empuja a los enemigos. Escala muy bien.
...
**Trucos:**
- [Rayo eléctrico]({{ '/conjuros/rayo-electrico/' | relative_url }}) <!-- TODO: crear página -->
- [Ráfaga de viento]({{ '/conjuros/rafaga-de-viento/' | relative_url }}) <!-- TODO: crear página -->

**Nivel 1-4:**
- [Relámpago]({{ '/conjuros/relampago/' | relative_url }}) <!-- TODO: crear página -->
- [Llamar relámpago]({{ '/conjuros/llamar-relampago/' | relative_url }}) <!-- TODO: crear página -->
...
- Puede volar para posicionarse
- Ignora resistencias elementales
- Efectos secundarios (ensordecido, tumbado)

### Debilidades
- Menos curación que otras builds
- Conjuros de electricidad inútiles contra algunos enemigos
- Menos versátil fuera de combate

---


[← Volver a Druida]({{ '/clases/druida/' | relative_url }})
