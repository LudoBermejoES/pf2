---
layout: page
permalink: /clases/druida/builds/druida-animal/
title: Druida Animal (Compañero)
parent: Druida
category: builds
source: PC1
tags: [compañero animal, apoyo, híbrido]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Constitución (+2), Fuerza o Destreza (+2) |
| **Orden Druídica** | Orden Animal |

## Armas

- **Mano Principal**: [Bastón]({{ '/equipo/armas/baston/' | relative_url }}) o [Hoz]({{ '/equipo/armas/hoz/' | relative_url }})

## Habilidades Importantes

- [Naturaleza]({{ '/habilidades/naturaleza/' | relative_url }}) — Comandar animales
- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — curar al compañero
...
La orden animal te conecta con las bestias del mundo. Obtienes el conjuro de orden *curación del compañero* que cura a tu compañero animal.

### Compañeros Animales Recomendados

| Animal | Rol | Fortaleza |
|--------|-----|-----------|
| **Oso** | Tanque | Alta CA y PG, absorbe daño |
| **Lobo** | Flanqueador | Derribos, trabaja en equipo |
| **Gato grande** | Daño | Alta movilidad, daño de precisión |
| **Serpiente** | Control | Veneno, agarre |
| **Caballo** | Montura | Movilidad para ti |
...
### Debilidades
- Tu compañero puede morir
- Requiere gestionar acciones de ambos
- Menos conjuros de daño directo
- El compañero necesita posicionamiento
