---
layout: page
permalink: /clases/guerrero/builds/arquero-precision/
title: Arquero de Precisión
parent: Guerrero
category: builds
source: PC1
tags: [daño, distancia, precisión]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Fuerza (+2 para arcos compuestos), Sabiduría (+1) |
| **Armadura** | [Cuero]({{ '/equipo/armaduras/cuero/' | relative_url }}) |

## Armas

- **Arma Principal**: [Arco largo compuesto]({{ '/equipo/armas/arco-largo-compuesto/' | relative_url }})
- **Arma Secundaria**: [Espada corta]({{ '/equipo/armas/espada-corta/' | relative_url }}) (para emergencias)

## Habilidades Importantes

- [Sigilo]({{ '/habilidades/sigilo/' | relative_url }})
- [Percepción]({{ '/habilidades/percepcion/' | relative_url }}) <!-- TODO: crear página -->
...
- Excelente precisión gracias a la competencia de guerrero
- Múltiples disparos por turno
- Seguro al estar lejos del combate cuerpo a cuerpo

### Debilidades
- Vulnerable si los enemigos llegan a cuerpo a cuerpo
- Depende de tener línea de visión clara
- Consumo de munición
...
- **Arco largo compuesto**: Permite añadir Fuerza al daño
- **Carcaj con al menos 40 flechas**
- **Flechas especiales**: Flechas de plata, frío, etc. para diferentes enemigos
- **Armadura ligera**: Mantén la movilidad

---


[← Volver a Guerrero]({{ '/clases/guerrero/' | relative_url }})
