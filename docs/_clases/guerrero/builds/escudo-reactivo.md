---
layout: page
permalink: /clases/guerrero/builds/escudo-reactivo/
title: Guerrero de Escudo Reactivo
parent: Guerrero
category: builds
source: PC1
tags: [tanque, defensa, control]
recommended: false
adventure_path: null
---
...
| **Armadura** | [Placas completas]({{ '/equipo/armaduras/placas-completas/' | relative_url }}) |

## Armas

- **Mano Principal**: [Espada larga]({{ '/equipo/armas/espada-larga/' | relative_url }}) o [Hacha de batalla]({{ '/equipo/armas/hacha-de-batalla/' | relative_url }})
- **Mano Secundaria**: Escudo pesado
...
- Protege activamente a los aliados
- Control del campo de batalla mediante empujones
- Múltiples reacciones a niveles altos

### Debilidades
- Menor daño ofensivo que otras configuraciones
- Depende de tener el escudo alzado
- Menos móvil que otros guerreros

---

## Prerrequisitos Importantes

Esta configuración requiere la reacción **Bloqueo con el Escudo**, que es un rasgo de clase general (no una dote de guerrero). Asegúrate de que tu personaje tiene acceso a esta reacción.
