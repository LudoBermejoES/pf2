---
layout: page
permalink: /clases/barbaro/builds/barbaro-furia/
title: Bárbaro de Furia Pura
parent: Bárbaro
category: builds
source: PC2
tags: [daño, críticos, resistencia]
recommended: false
adventure_path: null
---
...
- **Mano Principal**: [Espadón]({{ '/equipo/armas/espadon/' | relative_url }}) o [Hacha de batalla]({{ '/equipo/armas/hacha-de-batalla/' | relative_url }})

## Habilidades Importantes

- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — maximizar
- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — presencia amenazante
- [Supervivencia]({{ '/habilidades/supervivencia/' | relative_url }}) — resistencia
...
El instinto de furia representa la ira pura, sin conexión con espíritus o elementos. Tu daño adicional es contundente, cortante o perforante según tu arma.

### Ventajas del Instinto de Furia
...
- Excelente resistencia a daño físico
- Muchas reacciones ofensivas
- Críticos devastadores

### Debilidades
- Sin capacidades elementales o mágicas
- Vulnerable a daño de energía
