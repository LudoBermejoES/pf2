---
layout: page
permalink: /clases/barbaro/builds/barbaro-dragon/
title: Bárbaro del Dragón
parent: Bárbaro
category: builds
source: PC2
tags: [dragón, aliento, elemental]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Constitución (+3), Carisma (+1) |
| **Instinto** | Dragón |

## Armas

- **Mano Principal**: [Espadón]({{ '/equipo/armas/espadon/' | relative_url }}) o [Hacha de guerra]({{ '/equipo/armas/hacha-de-guerra/' | relative_url }})
...
- [Arcanos]({{ '/habilidades/arcanos/' | relative_url }}) — conocimiento de dragones
...
El instinto del dragón te conecta con un tipo específico de dragón, determinando tu elemento y la naturaleza de tu aliento.

### Tipos de Dragón

| Dragón | Elemento | Daño de Aliento |
|--------|----------|-----------------|
...
- Aliento de área devastador
- Vuelo en niveles altos
- Transformación dracónica impresionante

### Debilidades
- Aliento tiene enfriamiento de 10 minutos
- Menos resistencias que otros instintos
- Depende del tipo de dragón elegido
