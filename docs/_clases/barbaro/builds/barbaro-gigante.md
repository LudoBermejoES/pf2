---
layout: page
permalink: /clases/barbaro/builds/barbaro-gigante/
title: Bárbaro del Gigante
parent: Bárbaro
category: builds
source: PC2
tags: [gigante, alcance, control]
recommended: false
adventure_path: null
---
...
| Elemento | Elección |
|----------|----------|
| **Atributo Clave** | Fuerza (+4) |
| **Atributos Secundarios** | Constitución (+3), Sabiduría (+1) |
| **Instinto** | Gigante |

## Armas

- **Mano Principal**: [Alabarda]({{ '/equipo/armas/alabarda/' | relative_url }}) o [Guadaña]({{ '/equipo/armas/guadana/' | relative_url }}) (con alcance)

## Habilidades Importantes

- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — maximizar para maniobras
- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — presencia imponente
- [Naturaleza]({{ '/habilidades/naturaleza/' | relative_url }}) — conocimiento de gigantes
...
## Instinto del Gigante

El instinto del gigante te permite crecer en tamaño cuando entras en ira. Tu daño adicional es contundente, y obtienes alcance extendido.
...
Usa armas con el rasgo **alcance** para maximizar tu zona de control:
- [Alabarda]({{ '/equipo/armas/alabarda/' | relative_url }}) — versatil y daño sólido
- [Guadaña]({{ '/equipo/armas/guadana/' | relative_url }}) — daño mortal
- [Lucero del alba largo]({{ '/equipo/armas/lucero-del-alba-largo/' | relative_url }}) — contundente

### Fortalezas
- Alcance incomparable (hasta 6+ metros)
- Excelente control de zona
- Muchos enemigos en rango de reacción
- Maniobras potenciadas

### Debilidades
- Torpe 1 mientras creces
- Espacios reducidos limitan crecimiento
- Menos daño elemental que dragón

---


[← Volver a Bárbaro]({{ '/clases/barbaro/' | relative_url }})
