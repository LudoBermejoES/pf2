---
layout: page
permalink: /clases/hechicero/builds/hechicero-aberrante/
title: Hechicero Aberrante
parent: Hechicero
category: builds
source: PC2
tags: [oculto, mental, control]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Inteligencia (+2), Constitución (+2) |
| **Linaje** | Aberrante (Oculto) |

## Armas

- **Mano Principal**: [Bastón]({{ '/equipo/armas/baston/' | relative_url }}) (foco oculto)

## Habilidades Importantes

- [Ocultismo]({{ '/habilidades/ocultismo/' | relative_url }}) — tradición oculta
- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — presencia perturbadora
- [Engaño]({{ '/habilidades/engano/' | relative_url }}) — manipulación mental
- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — conocimiento anatómico
...
El linaje aberrante te conecta con entidades del Oscuro Tapiz y otros horrores cósmicos. Obtienes conjuros ocultos con énfasis en efectos mentales.

### Magia de Sangre Aberrante

Tu magia de sangre distorsiona la percepción, causando que los enemigos te vean de forma diferente o confundiendo sus sentidos.
...
- Repertorio expandido masivamente
- Muy efectivo contra humanoides
- Daño mental atraviesa armaduras

### Debilidades
- Ineficaz contra constructos y muertos vivientes (inmunes a mental)
- Menos daño directo que linajes elementales
- Requiere conocer inmunidades enemigas
