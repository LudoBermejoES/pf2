---
layout: page
permalink: /clases/hechicero/builds/hechicero-divino/
title: Hechicero del Linaje Divino
parent: Hechicero
category: builds
source: PC2
tags: [curación, apoyo, divino]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Sabiduría (+2), Constitución (+2) |
| **Linaje** | Angelical, Demoníaco u otro divino |

## Armas

- **Mano Principal**: [Bastón]({{ '/equipo/armas/baston/' | relative_url }}) (símbolo sagrado incorporado)

## Habilidades Importantes

- [Religión]({{ '/habilidades/religion/' | relative_url }}) — conocimiento divino
- [Medicina]({{ '/habilidades/medicina/' | relative_url }}) — curación mundana
- [Diplomacia]({{ '/habilidades/diplomacia/' | relative_url }}) — presencia carismática
- [Sociedad]({{ '/habilidades/sociedad/' | relative_url }}) — instituciones religiosas
...
Los linajes divinos te conectan con planos superiores o inferiores. Obtienes conjuros divinos con acceso a curación y protección.

### Opciones de Linaje

| Linaje | Fuente | Enfoque |
|--------|--------|---------|
| Angelical | Celestiales | Curación y protección |
| Demoníaco | Demonios | Daño y corrupción |
| Diabólico | Diablos | Control y pactos |
| Psicopompo | Espíritus | Muerte y transición |
...
### Fortalezas
- Sanador efectivo sin ser clérigo
- Flexibilidad entre sanar y dañar
- No requiere devoción a una deidad
- Excelente contra muertos vivientes (dañar)

### Debilidades
- Menos conjuros de ataque que otros hechiceros
- Compite con clérigos como sanador
- Linaje puede crear conflictos de rol

---


[← Volver a Hechicero]({{ '/clases/hechicero/' | relative_url }})
