---
layout: page
permalink: /clases/hechicero/builds/hechicero-draconico/
title: Hechicero Dracónico
parent: Hechicero
category: builds
source: PC2
tags: [daño, elemental, dragón]
recommended: false
adventure_path: null
---
...
| **Atributos Secundarios** | Constitución (+3), Destreza (+1) |
| **Linaje** | Dracónico (Arcano) |

## Armas

- **Mano Principal**: [Bastón]({{ '/equipo/armas/baston/' | relative_url }}) o garras (si mutación)

## Habilidades Importantes

- [Arcanos]({{ '/habilidades/arcanos/' | relative_url }}) — tradición arcana
- [Intimidación]({{ '/habilidades/intimidacion/' | relative_url }}) — presencia dracónica
- [Sociedad]({{ '/habilidades/sociedad/' | relative_url }}) — conocimiento de linajes
- [Atletismo]({{ '/habilidades/atletismo/' | relative_url }}) — si combates cuerpo a cuerpo
...
El linaje dracónico te conecta con un tipo específico de dragón, determinando tu elemento y resistencia. Obtienes conjuros arcanos con énfasis en daño elemental.

### Tipos de Dragón

| Dragón | Elemento | Tipo de Daño |
|--------|----------|--------------|
| Rojo/Dorado/Latón | Fuego | Fuego |
| Blanco/Plata | Frío | Frío |
| Azul/Bronce | Electricidad | Electricidad |
| Verde | Veneno | Veneno |
| Negro/Cobre | Ácido | Ácido |
...
**Trucos:**
- Rayo de fuego (o equivalente elemental)
- Escudo
- Producir llama
...
### Fortalezas
- Daño masivo de área
- Atraviesa resistencias elementales
- Opciones defensivas sólidas
- Vuelo permanente a nivel alto

### Debilidades
- Menos versatilidad que otros linajes
- Ineficaz contra inmunes a tu elemento
- Puede dañar aliados con conjuros de área
