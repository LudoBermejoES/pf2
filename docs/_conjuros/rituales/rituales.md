...
| Rango | Ritual | Rasgos |
|-------|--------|--------|
| 2 | [Animar Objeto]({{ '/conjuros/rituales/animar-objeto/' | relative_url }}) | Poco comun |
| 4 | [Asolar]({{ '/conjuros/rituales/asolar/' | relative_url }}) | Poco comun, planta, vacío |
| 6 | [Circulo de Ligadura]({{ '/conjuros/rituales/circulo-de-ligadura/' | relative_url }}) | Poco comun |
| 6 | [Comunion]({{ '/conjuros/rituales/comunion/' | relative_url }}) | Poco comun, predicción |
| 2 | [Consagrar]({{ '/conjuros/rituales/consagrar/' | relative_url }}) | Poco comun, consagracion |
| 8 | [Controlar el Clima]({{ '/conjuros/rituales/controlar-el-clima/' | relative_url }}) | Poco comun |
| 2 | [Crear Muerto Viviente]({{ '/conjuros/rituales/crear-muerto-viviente/' | relative_url }}) | Poco comun, sacrilego |
| 4 | [Crecimiento Vegetal]({{ '/conjuros/rituales/crecimiento-vegetal/' | relative_url }}) | Poco comun, madera, planta, vitalidad |
| 10 | [Deseo]({{ '/conjuros/rituales/deseo/' | relative_url }}) | Raro |
| 7 | [Desplazamiento Planario]({{ '/conjuros/rituales/desplazamiento-planario/' | relative_url }}) | Poco comun, teletransporte |
| 6 | [Dotar de Consciencia a un Animal]({{ '/conjuros/rituales/dotar-de-consciencia-a-un-animal/' | relative_url }}) | Poco comun, mental |
| 4 | [Expiar]({{ '/conjuros/rituales/expiar/' | relative_url }}) | Poco comun |
| 3 | [Geas]({{ '/conjuros/rituales/geas/' | relative_url }}) | Poco comun, maldición, mental |
| 6 | [Llamada Primigenia]({{ '/conjuros/rituales/llamada-primigenia/' | relative_url }}) | Poco comun |
| 5 | [Llamar a un Espíritu]({{ '/conjuros/rituales/llamar-a-un-espiritu/' | relative_url }}) | Poco comun, espíritu |
