...
source: PC1
---
## Convocar Monitor {% include accion.html tipo="3" %} [CONJURO 5]

<img src="{{ '/assets/images/conjuros/convocar-monitor.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">
