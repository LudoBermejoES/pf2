...
source: PC1
---
<img src="{{ '/assets/images/conjuros/presa-del-geco.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">

## Presa del Geco {% include accion.html tipo="2" %} [CONJURO 2]
