---
layout: spell
permalink: /conjuros/orden/
title: Orden
chapter: Conjuros
spell_level: 1
source: PC1
---
## Orden {% include accion.html tipo="2" %} [CONJURO 1]

<img src="{{ '/assets/images/conjuros/orden.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">
