---
layout: spell
permalink: /conjuros/dilema/
title: Dilema
chapter: Conjuros
spell_level: 8
source: PC1
---
## Dilema {% include accion.html tipo="2" %} [CONJURO 8]

<img src="{{ '/assets/images/conjuros/dilema.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">
