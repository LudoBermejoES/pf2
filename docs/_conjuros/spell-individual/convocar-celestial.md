...
source: PC1
---
<img src="{{ '/assets/images/conjuros/convocar-celestial.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">

## Convocar Celestial {% include accion.html tipo="3" %} [CONJURO 5]
