...
El conjuro es altamente impreciso y apareces a 1d20 x 25 millas (1 milla = 1,6 km) desde el ultimo lugar en el que uno de los objetivos (a tu eleccion) estaba ubicado la ultima vez que viajo a dicho Plano. Si es la primera vez que todos los objetivos viajan a un Plano en particular, aparecen en una ubicacion aleatoria del mismo. Teletransporte interplanar no proporciona un medio de viaje de retorno, aunque lanzarlo de nuevo te permite volver a tu Plano anterior a menos que concurran circunstancias atenuantes.