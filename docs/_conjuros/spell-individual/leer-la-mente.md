...
source: PC1
---
<img src="{{ '/assets/images/conjuros/leer-la-mente.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">

## Leer la Mente {% include accion.html tipo="2" %} [CONJURO 3]
