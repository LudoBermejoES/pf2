...
source: PC1
---
## Convocar Dragon {% include accion.html tipo="3" %} [CONJURO 5]

<img src="{{ '/assets/images/conjuros/convocar-dragon.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">
