---
layout: spell
permalink: /conjuros/invisibilidad/
title: Invisibilidad
chapter: Conjuros
spell_level: 2
source: PC1
...
<img src="{{ '/assets/images/conjuros/invisibilidad.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">

## Invisibilidad {% include accion.html tipo="2" %} [CONJURO 2]
