---
layout: spell
permalink: /conjuros/hechizar/
title: Hechizar
chapter: Conjuros
spell_level: 1
source: PC1
---
<img src="{{ '/assets/images/conjuros/hechizar.png' | relative_url }}" class="spell-card-image" alt="Carta de conjuro">

## Hechizar {% include accion.html tipo="2" %} [CONJURO 1]
