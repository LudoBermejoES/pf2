---
layout: page
permalink: /habilidades/arcanos/pedir-prestado-un-conjuro-arcano/
...
<img src="{{ '/assets/images/acciones/pedir-prestado-un-conjuro-arcano.png' | relative_url }}" class="action-card-image" alt="Carta de acción">
