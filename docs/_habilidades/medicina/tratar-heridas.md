...
<div class="feat-traits-header" markdown="0"><a href="/rasgos/curacion/" class="feat-trait">Curación</a><a href="/rasgos/exploracion/" class="feat-trait">Exploración</a><a href="/rasgos/manipular/" class="feat-trait">Manipular</a></div>

<img src="{{ '/assets/images/acciones/tratar-heridas.png' | relative_url }}" class="action-card-image" alt="Carta de acción">
