---
layout: page
permalink: /ascendencias/hobgoblin/dotes/
title: Dotes de ascendencia para Hobgoblin
...
<div class="feat-traits-header" markdown="0"><span class="feat-trait">Hobgoblin</span></div>
...
Obtienes la dote general Saber adicional para Saber hobgoblin.
...
Tu entrenamiento de combate te ha afinado para estar listo ante un ataque en todo momento. Interactúas para desenvainar un arma.
...
<div class="feat-traits-header" markdown="0"><span class="feat-trait">Sanación</span><span class="feat-trait">Hobgoblin</span><span class="feat-trait">Vitalidad</span></div>

**Frecuencia:** una vez por día

La energía vital que fluye en tu sangre te revitaliza. Recuperas 4d6 Puntos de Golpe y ganas 10 Puntos de Golpe temporales durante 1 minuto. A nivel 15, en su lugar recuperas 6d6 PG y ganas 15 PG temporales.
...
Te has entrenado con tu compañero animal para convertirte en una mole aterradora en el campo de batalla. Tu compañero animal pasa a estar entrenado en Intimidación. Si tu compañero animal usa Apoyar mientras te sirve de montura, te otorga los efectos de la reacción Ayudar en tu primera prueba de Intimidación para Desmoralizar en el mismo turno, aunque no pueda realizar reacciones.

---

### Orgullo en armas · Dote 9 · {% include accion.html tipo="libre" %}

<div class="feat-traits-header" markdown="0"><span class="feat-trait">Auditivo</span><span class="feat-trait">Emoción</span><span class="feat-trait">Hobgoblin</span><span class="feat-trait">Mental</span></div>

**Desencadenante:** Un aliado a 30 pies reduce a un enemigo a 0 Puntos de Golpe.

Con un grito de triunfo, concedes inspiración para que un aliado siga luchando. El aliado desencadenante gana Puntos de Golpe temporales iguales a su modificador de Constitución hasta el final de su siguiente turno.
...
<div class="feat-traits-header" markdown="0"><span class="feat-trait">Auditivo</span><span class="feat-trait">Hobgoblin</span><span class="feat-trait">Manipular</span></div>

**Frecuencia:** una vez por día

**Desencadenante:** Un aliado adyacente y dispuesto fuese a quedar reducido a 0 PG pero no morir.

Ayudas físicamente a un aliado a permanecer en pie y lo animas a superar el dolor contra todo pronóstico. Tu aliado no cae inconsciente y permanece a 1 Punto de Golpe. El aliado también gana una cantidad de Puntos de Golpe temporales igual a tu nivel que duran 1 minuto. Seguir luchando con tal herida no está exento de consecuencias; la condición herido de tu aliado aumenta en 1.
...
La energía que fluye en tu sangre puede salvar una vida en los momentos más aciagos. Evitas que la criatura muera y le restauras 6d8 + tu modificador de Constitución Puntos de Golpe. No puedes usar Restauración cantoriana si el efecto detonante era un efecto de muerte o un efecto que no deja restos, como desintegrar.

---

### Grito de arenga · Dote 17 · {% include accion.html tipo="2" %}

<div class="feat-traits-header" markdown="0"><span class="feat-trait">Auditivo</span><span class="feat-trait">Hobgoblin</span></div>

**Frecuencia:** una vez por día

Llamas a tus aliados y los empujas a darlo todo en combate. Todos los aliados en una emanación de 30 pies que puedan oírte ganan una cantidad de Puntos de Golpe temporales igual a tu nivel. Además, estos aliados quedan acelerados durante 1 minuto, pero la acción adicional solo puede usarse para Dar un paso, Avanzar o Golpear.
