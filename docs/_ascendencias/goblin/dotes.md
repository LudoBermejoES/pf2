...
**Beneficio:** Haz una prueba de Interpretar contra la CD de Voluntad de un solo enemigo a 30 pies (9 m) o menos. Esto tiene todos los rasgos y restricciones habituales de una prueba de Interpretar para cantar (pag. 240).
