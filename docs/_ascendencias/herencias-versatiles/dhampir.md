---
layout: page
permalink: /ascendencias/herencias-versatiles/dhampir/
title: Dhampir
...
Un dhampiro generalmente se asemeja a un miembro de la ascendencia de su progenitor no vampiro, pero con un pálido fantasmal y ojos tan claros que parecen tener solo pupilas diminutas y sin iris. Todos los dhampiros tienen incisivos alargados, algunos casi tan largos como los de un vampiro verdadero. Muchos poseen gracia, belleza y encanto a pesar de su apariencia inquietante.

## Podrías...

- Distanciarte de tu herencia intentando integrarte en la sociedad o incluso cazando no muertos.
- Tomar precauciones especiales para evitar exponerte a magia curativa “beneficiosa”.
- Encontrarte fascinado por la vista, el olor o el sabor de la sangre.

## Otros probablemente...

- Se sientan inquietos por tu palidez fantasmal y tus dientes afilados.
- Se pregunten o incluso romantizen tus orígenes y motivaciones.
- Se sientan extrañamente atraídos por tu gracia, encanto y apariencia.

## Dhampir (Herencia versátil poco común)

Eres el vástago de un vampiro, mitad vivo y mitad no muerto, dotado de un encanto y una gracia inusuales, una palidez sin sangre e incisivos alargados. Obtienes el rasgo dhampir, además de los rasgos de tu ascendencia. Tienes la capacidad de sanación del vacío, lo que significa que los efectos de vitalidad te perjudican y los efectos de vacío te sanan como si fueras un no muerto. También obtienes visión en penumbra, o visión en la oscuridad si tu ascendencia ya tiene visión en penumbra. Puedes seleccionar entre dotes de dhampir y dotes de tu ascendencia siempre que obtengas una dote de ascendencia.

---

## Linajes

Un dhampir puede seleccionar cualquiera de los siguientes linajes.

### Straveika · Dote 1

<div class="feat-traits-header" markdown="0"><span class="feat-trait">Dhampir</span><span class="feat-trait">Linaje</span></div>
...
<div class="feat-traits-header" markdown="0"><span class="feat-trait">Dhampir</span></div>
...
Emulas las técnicas de tu progenitor vampírico para extraer sangre de una víctima. Tus Golpes con colmillos infligen 1d4 de daño persistente por desangrado adicional con un impacto crítico.
...
<div class="feat-traits-header" markdown="0"><span class="feat-trait">Concentrar</span><span class="feat-trait">Dhampir</span><span class="feat-trait">Divino</span><span class="feat-trait">Polimorfo</span></div>

**Frecuencia:** una vez por hora

Puedes transformarte en un murciélago inofensivo. Obtienes los efectos de *forma de plaga* de rango 4, excepto que siempre te transformas en un murciélago.
