---
layout: page
permalink: /ascendencias/mediano/dotes_short/
...
A 1.er nivel, obtienes una dote de ascendencia y otra adicional cada 4 niveles posteriores (en 5.º, 9.º, 13.º y 17.º nivel). Como mediano, puedes elegir entre las siguientes dotes de ascendencia.
...
| Dote | Descripción | Rasgos | Requisitos |
|------|-------------|--------|------------|
| [Danza derribadora](/dotes/mediano/danza-derribadora/) | Mientras compartes el espacio de una criatura con Bailar bajo los pies, tus golpes obtienen el rasgo derribo contra esa criatura. | Bailar bajo los pies |
