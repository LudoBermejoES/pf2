---
layout: page
permalink: /tu-personaje/creacion-personajes/
...
5. **Elige una clase** - Determina las aptitudes heroicas de tu personaje
...
## Paso 2: Empieza a construir modificadores por atributo

Todos los modificadores por atributo de tu personaje empiezan en **+0**. Conforme seleccionas tu ascendencia, bagaje y clase, aplicaras:

- **Mejoras de atributo**: Incrementan en 1 un modificador
- **Defectos de atributo**: Reducen en 1 un modificador
...
Una mejora de atributo suele incrementar en 1 el valor de un modificador. Sin embargo, si el modificador al que estas aplicando una mejora ya es **+4 o superior**, en su lugar has de marcar "mejora parcial" en la hoja de personaje para dicho atributo. Si ya tenia una marca parcial, mejora en 1 el atributo y borra la marca.

**A 1er nivel, un personaje nunca puede tener un modificador por atributo superior a +4.**

Cuando obtienes mejoras de atributo multiples al mismo tiempo, debes aplicar cada una a un modificador diferente.

### Defectos de atributo

Si tu personaje tiene un defecto de atributo (probablemente debido a su ascendencia), reduces en 1 el modificador por dicho atributo.
...
El bagaje de tu personaje representa su educacion, una aptitud que lleva refinando desde su juventud u otro aspecto de su vida antes de convertirse en aventurero.
...
## Paso 7: Anota los detalles de tu clase

Ahora, anota todos los beneficios y rasgos de clase que tu personaje obtiene debido a la clase elegida.
...
A 1er nivel, tu personaje dispone de **15 po (150 pp)** para gastar en armadura, armas y otro equipo basico.
...
El modificador para un Golpe es igual al bonificador por competencia de tu personaje con dicha arma mas su modificador por atributo:

- **Golpes cuerpo a cuerpo**: Generalmente usan Fuerza
- **Golpes a distancia**: Generalmente usan Destreza
...
## Paso 10: Detalles de acabado

Ahora anade los siguientes detalles a tu hoja de personaje.

### Edictos y anatemas

Puedes adoptar edictos y anatemas para reforzar las creencias de tu personaje y guiar como reacciona en determinadas situaciones.
...
Adam pasa al equipo. Esta entrenado en armadura intermedia y elige una armadura de pieles. En cuanto a armas, se decide por una lanza corta, pero compra dos en caso de que quisiera arrojar la primera.

Anota la lanza corta tanto en Golpes cuerpo a cuerpo como en Golpes a distancia, y tambien anota las garras que obtiene de forma indomita en sus Golpes cuerpo a cuerpo, puesto que esta seguro de que va a usar dicho conjuro con frecuencia.
