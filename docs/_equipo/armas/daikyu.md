...
<img src="{{ '/assets/images/armas/daikyu.png' | relative_url }}" class="weapon-card-image" alt="Carta de arma">
...
|------|--------|------|----------|---------|------|-------|-------|----------------|
| Daikyu | 8 mo | 1d8 Per | 80 pies | 0 | 2 | 1+ | Arcos | Fuerte, propulsivo |
