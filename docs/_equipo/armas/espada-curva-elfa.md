---
layout: page
permalink: /equipo/armas/espada-curva-elfa/
title: Espada curva elfa
chapter: Equipo
category: equipo
nav_order: 33
source: PC1
---
<img src="{{ '/assets/images/armas/espada-curva-elfa.png' | relative_url }}" class="weapon-card-image" alt="Carta de arma">
