---
layout: page
permalink: /equipo/objetos/material-detective/
title: Material de Detective
chapter: Equipo
category: equipo
nav_order: 29
source: PC1
---
<img src="{{ '/assets/images/objetos/material-detective.png' | relative_url }}" class="spell-card-image" alt="Carta de objeto">
