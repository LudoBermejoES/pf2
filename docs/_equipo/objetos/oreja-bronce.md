---
layout: page
permalink: /equipo/objetos/oreja-bronce/
title: Oreja de Bronce
chapter: Equipo
category: equipo
nav_order: 36
source: PC1
---
<img src="{{ '/assets/images/objetos/oreja-bronce.png' | relative_url }}" class="spell-card-image" alt="Carta de objeto">
