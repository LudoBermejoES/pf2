---
layout: page
permalink: /equipo/objetos/abrojos/
title: Abrojos
chapter: Equipo
category: equipo
nav_order: 1
source: PC1
---
<img src="{{ '/assets/images/objetos/abrojos.png' | relative_url }}" class="spell-card-image" alt="Carta de objeto">
