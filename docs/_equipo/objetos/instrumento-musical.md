---
layout: page
permalink: /equipo/objetos/instrumento-musical/
...
source: PC1
---
<img src="{{ '/assets/images/objetos/instrumento-musical.png' | relative_url }}" class="spell-card-image" alt="Carta de objeto">
