---
layout: page
permalink: /equipo/objetos/vaina-parada/
title: Vaina de Parada
chapter: Equipo
category: equipo
nav_order: 49
source: PC1
---
<img src="{{ '/assets/images/objetos/vaina-parada.png' | relative_url }}" class="spell-card-image" alt="Carta de objeto">
