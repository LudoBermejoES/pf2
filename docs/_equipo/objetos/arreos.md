---
layout: page
permalink: /equipo/objetos/arreos/
title: Arreos
chapter: Equipo
category: equipo
nav_order: 5
...
<img src="{{ '/assets/images/objetos/arreos.png' | relative_url }}" class="item-card-image" alt="Carta de objeto">
