---
layout: page
permalink: /equipo/armaduras/ropa-acolchada/
title: Ropa Acolchada
chapter: Equipo
category: equipo
nav_order: 11
source: PC1
---
<img src="{{ '/assets/images/armaduras/ropa-acolchada.png' | relative_url }}" class="armor-card-image" alt="Carta de armadura">


**Precio** 2 pp

<div class="feat-traits-header" markdown="0"><a href="/apendices/rasgos/comoda/" class="feat-trait">Comoda</a></div>

---

**Bon. CA** +1; **Tope Des.** +3; **Fuerza** +0; **Impedimenta** L; **Categoría** Armadura ligera
