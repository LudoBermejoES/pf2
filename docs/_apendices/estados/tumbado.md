---
layout: page
permalink: /apendices/estados/tumbado/
title: Tumbado
chapter: Apéndices
category: apéndices
nav_order: 43
...
Si algo te haría quedar tumbado cuando estás Trepando o Volando, caes al suelo (ver pág. 421 ([ver](/reglas/movimiento/)) para las reglas sobre caídas). No puedes quedar tumbado mientras estás Nadando.
