---
layout: page
permalink: /dotes/arquetipo/medico/tratar-condicion-include-accion-html-tipo-2/
title: Tratar condición · {% include accion.html tipo="2" %}
chapter: Dotes
category: dotes
archetype: Medico
...
## Tratar condición · {% include accion.html tipo="2" %}
