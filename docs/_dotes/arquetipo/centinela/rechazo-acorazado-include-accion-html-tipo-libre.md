---
layout: page
permalink: /dotes/arquetipo/centinela/rechazo-acorazado-include-accion-html-tipo-libre/
title: Rechazo acorazado · {% include accion.html tipo="libre" %}
chapter: Dotes
category: dotes
archetype: Centinela
...
## Rechazo acorazado · {% include accion.html tipo="libre" %}
