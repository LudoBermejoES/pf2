---
layout: page
permalink: /dotes/arquetipo/artista-marcial/golpe-atroz-include-accion-html-tipo-2/
title: Golpe atroz · {% include accion.html tipo="2" %}
chapter: Dotes
category: dotes
...
## Golpe atroz · {% include accion.html tipo="2" %}
