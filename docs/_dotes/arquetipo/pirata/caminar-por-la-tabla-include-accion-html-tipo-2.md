---
layout: page
permalink: /dotes/arquetipo/pirata/caminar-por-la-tabla-include-accion-html-tipo-2/
title: Caminar por la tabla · {% include accion.html tipo="2" %}
chapter: Dotes
category: dotes
archetype: Pirata
...
## Caminar por la tabla · {% include accion.html tipo="2" %}
