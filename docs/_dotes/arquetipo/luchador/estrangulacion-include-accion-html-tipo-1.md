---
layout: page
permalink: /dotes/arquetipo/luchador/estrangulacion-include-accion-html-tipo-1/
title: Estrangulación · {% include accion.html tipo="1" %}
chapter: Dotes
category: dotes
archetype: Luchador
...
## Estrangulación · {% include accion.html tipo="1" %}
