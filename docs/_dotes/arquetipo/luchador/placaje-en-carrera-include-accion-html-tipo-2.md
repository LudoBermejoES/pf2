---
layout: page
permalink: /dotes/arquetipo/luchador/placaje-en-carrera-include-accion-html-tipo-2/
title: Placaje en carrera · {% include accion.html tipo="2" %}
chapter: Dotes
category: dotes
archetype: Luchador
...
## Placaje en carrera · {% include accion.html tipo="2" %}
