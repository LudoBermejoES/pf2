---
layout: page
permalink: /dotes/arquetipo/luchador/rompe-codos-include-accion-html-tipo-1/
title: Rompe codos · {% include accion.html tipo="1" %}
chapter: Dotes
category: dotes
archetype: Luchador
...
## Rompe codos · {% include accion.html tipo="1" %}
