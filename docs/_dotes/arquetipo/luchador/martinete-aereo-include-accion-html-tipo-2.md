---
layout: page
permalink: /dotes/arquetipo/luchador/martinete-aereo-include-accion-html-tipo-2/
title: Martinete aéreo · {% include accion.html tipo="2" %}
chapter: Dotes
category: dotes
archetype: Luchador
...
## Martinete aéreo · {% include accion.html tipo="2" %}
