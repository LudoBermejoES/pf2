---
layout: page
permalink: /dotes/arquetipo/explorador/sombra-fugaz-include-accion-html-tipo-2/
title: Sombra fugaz · {% include accion.html tipo="2" %}
chapter: Dotes
category: dotes
...
## Sombra fugaz · {% include accion.html tipo="2" %}
