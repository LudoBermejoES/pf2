---
layout: page
permalink: /dotes/arquetipo/demoledor/martillazo-sismico-include-accion-html-tipo-3/
title: Martillazo sísmico · {% include accion.html tipo="3" %}
chapter: Dotes
category: dotes
archetype: Demoledor
...
## Martillazo sísmico · {% include accion.html tipo="3" %}
