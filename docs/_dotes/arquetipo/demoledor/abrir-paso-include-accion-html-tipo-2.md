---
layout: page
permalink: /dotes/arquetipo/demoledor/abrir-paso-include-accion-html-tipo-2/
title: Abrir paso · {% include accion.html tipo="2" %}
chapter: Dotes
category: dotes
archetype: Demoledor
...
## Abrir paso · {% include accion.html tipo="2" %}
