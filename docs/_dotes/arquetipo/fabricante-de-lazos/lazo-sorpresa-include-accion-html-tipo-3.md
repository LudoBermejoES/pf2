---
layout: page
permalink: /dotes/arquetipo/fabricante-de-lazos/lazo-sorpresa-include-accion-html-tipo-3/
title: Lazo sorpresa · {% include accion.html tipo="3" %}
chapter: Dotes
category: dotes
...
## Lazo sorpresa · {% include accion.html tipo="3" %}
