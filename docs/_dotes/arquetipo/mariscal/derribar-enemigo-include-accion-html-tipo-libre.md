---
layout: page
permalink: /dotes/arquetipo/mariscal/derribar-enemigo-include-accion-html-tipo-libre/
title: Derribar enemigo · {% include accion.html tipo="libre" %}
chapter: Dotes
category: dotes
archetype: Mariscal
...
## Derribar enemigo · {% include accion.html tipo="libre" %}
