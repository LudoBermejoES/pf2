---
layout: page
permalink: /dotes/arquetipo/vikingo/segundo-escudo-include-accion-html-tipo-libre/
title: Segundo escudo · {% include accion.html tipo="libre" %}
chapter: Dotes
category: dotes
archetype: Vikingo
...
## Segundo escudo · {% include accion.html tipo="libre" %}
