---
layout: page
permalink: /dotes/arquetipo/vikingo/a-la-refriega-include-accion-html-tipo-2/
title: A la refriega · {% include accion.html tipo="2" %}
chapter: Dotes
category: dotes
archetype: Vikingo
...
## A la refriega · {% include accion.html tipo="2" %}
