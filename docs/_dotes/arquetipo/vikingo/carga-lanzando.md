---
layout: page
permalink: /dotes/arquetipo/vikingo/carga-lanzando/
title: Carga lanzando
chapter: Dotes
category: dotes
archetype: Vikingo
...
## Carga lanzando · {% include accion.html tipo="2" %}

<div class="feat-traits-header" markdown="0"><a href="/apendices/rasgos/arquetipo/" class="feat-trait">Arquetipo</a></div>

<div class="feat-card">
  <img src="/assets/cards/feats/carga-lanzando.png" alt="Carta de dote">
</div>
