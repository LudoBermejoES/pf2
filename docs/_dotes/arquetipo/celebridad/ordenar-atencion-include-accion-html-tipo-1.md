---
layout: page
permalink: /dotes/arquetipo/celebridad/ordenar-atencion-include-accion-html-tipo-1/
title: Ordenar atención · {% include accion.html tipo="1" %}
chapter: Dotes
category: dotes
...
## Ordenar atención · {% include accion.html tipo="1" %}
