...
| **Reflejos** | Experto |
| **Voluntad** | Experto |
| **Habilidades** | Entrenado en un número de habilidades igual a 4 + tu modificador de Inteligencia |
| **Ataques** | Entrenado en armas simples y ataques desarmados |
| **Defensas** | No entrenado en todas las armaduras, Experto en defensa sin armadura |
| **CD de clase** | Entrenado en la CD de clase de monje |

## Durante los encuentros

- **Combate:** Te lanzas veloz a la refriega, esquivando u ordenando saltos sobre obstáculos con maniobras acrobáticas. Golpeas a los oponentes con una rápida ráfaga de ataques, usando tus puños desnudos o empuñando armas especializadas que dominaste durante tu entrenamiento monástico.
- **Social:** Tu perspicacia te permite ver a través de las falsedades, y tu formación filosófica aporta entendimiento en cualquier situación.
- **Exploración:** Trepas muros, esquivas trampas, superas obstáculos y saltas fosos. Sueles quedarte hacia el exterior del grupo para proteger a los miembros más vulnerables.
- **Entre aventuras:** Te ejercitas con diligencia, comes saludable, meditas y estudias diversas filosofías. También puedes dedicarte a un oficio que te esfuerzas por perfeccionar.

## Podrías...

- Mantener un régimen de entrenamiento físico y meditación.
- Enfrentar la adversidad con calma y mesura, sin entrar en pánico ni sucumbir a la desesperación.
- Mirar al futuro en busca de formas de mejorar, permaneciendo en paz con tu yo presente.

## Otros probablemente...

- Se asombren de tus proezas físicas.
- Piensen que eres algo rígido, dada tus votos y principios.
...
|-------|----------------|
| 1 | Ascendencia y trasfondo, aumentos de atributos, competencias iniciales, ráfaga de golpes, dote de monje, puño poderoso |
| 2 | Dote de monje, dote de habilidad |
| 3 | Dote general, movimiento increíble +3 m, golpes místicos, aumento de habilidad |
| 4 | Dote de monje, dote de habilidad |
| 5 | Aumentos de atributos, dote de ascendencia, golpes expertos, pericia en Percepción, aumento de habilidad |
| 6 | Dote de monje, dote de habilidad |
| 7 | Dote general, movimiento increíble +4,5 m, camino hacia la perfección, aumento de habilidad, especialización en armas |
| 8 | Dote de monje, dote de habilidad |
| 9 | Dote de ascendencia, golpes metálicos, pericia de monje, aumento de habilidad |
| 10 | Aumentos de atributos, dote de monje, dote de habilidad |
| 11 | Dote general, movimiento increíble +6 m, segundo camino hacia la perfección, aumento de habilidad |
| 12 | Dote de monje, dote de habilidad |
| 13 | Dote de ascendencia, maestría grácil, golpes maestros, aumento de habilidad |
| 14 | Dote de monje, dote de habilidad |
| 15 | Aumentos de atributos, dote general, mayor especialización en armas, movimiento increíble +7,5 m, aumento de habilidad, tercer camino hacia la perfección |
| 16 | Dote de monje, dote de habilidad |
| 17 | Golpes de adamantina, dote de ascendencia, leyenda grácil, aumento de habilidad |
| 18 | Dote de monje, dote de habilidad |
| 19 | Dote general, movimiento increíble +9 m, forma perfeccionada, aumento de habilidad |
| 20 | Aumentos de atributos, dote de monje, dote de habilidad |
...
Adoptas una postura especializada para un arte marcial centrado en el uso del arco. Mientras estás en esta postura, los únicos Golpes que puedes realizar son los que usan arcos largos, arcos cortos o arcos con el rasgo de monje. Puedes usar Ráfaga de golpes con estos arcos.

---

## Términos clave

**Florecer:** Las acciones con este rasgo son técnicas especiales que requieren demasiado esfuerzo para usarlas con frecuencia. Solo puedes usar 1 acción con el rasgo florecer por turno.

**Incapacitante:** Una habilidad con este rasgo puede sacar a un personaje del combate. Pero cuando usas un efecto incapacitante contra una criatura de nivel superior al tuyo, reduces en un grado tu resultado de éxito en la tirada de ataque, y esa criatura mejora en un grado el resultado de éxito en sus TS.

**Conjuros de qi:** Al acceder a una reserva interior de energía, llamada qi, puedes lanzar conjuros especiales llamados conjuros de qi, que son un tipo de conjuro de foco. Cuesta 1 Punto de foco lanzar un conjuro de foco. Cuando obtienes tu primer conjuro de qi, decides si tus conjuros de qi son divinos u ocultos, y pasas a estar entrenado en modificadores de ataque de conjuros y CD de conjuros; tu atributo clave de lanzamiento de conjuros es Sabiduría.

**Postura:** Una postura es una estrategia de combate general a la que entras usando una acción con el rasgo postura, y en la que permaneces durante un tiempo. Una postura dura hasta que quedas fuera de combate, hasta que se violan sus requisitos, hasta que termina el encuentro o hasta que vuelves a usar una acción de postura.

**Venenoso:** Estas armas inyectan veneno en cada impacto. Cuando golpeas a una criatura con esta arma, inflige 1 de daño de veneno persistente adicional. Esto aumenta a 2 de daño de veneno persistente si el arma tiene una runa de golpe mayor.
...
**Camino hacia la perfección (7º):** Elige tus TS de Fortaleza, Reflejos o Voluntad. Tu rango de competencia para la TS elegida aumenta a maestro. Cuando obtienes un éxito en la TS elegida, en su lugar obtienes un éxito crítico.
...
**Segundo camino hacia la perfección (11º):** Elige una TS diferente de la que escogiste para camino hacia la perfección. Tu rango de competencia para esa TS aumenta a maestro. Si obtienes un éxito, en su lugar obtienes un éxito crítico.
...
**Forma perfeccionada (19º):** En tu primer Golpe de tu turno, si tiras menos de 10, puedes tratar la tirada de ataque como un 10. Esto es un efecto de fortuna.
