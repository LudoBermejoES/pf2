...
| Blasting stone, lesser | Bomb | 3 gp |
| Blight bomb, lesser | Bomb | 3 gp |
| Bottled lightning, lesser | Bomb | 3 gp |
| Dread ampoule, lesser | Bomb | 3 gp |
| Frost vial, lesser | Bomb | 3 gp |
| Ghost charge, lesser | Bomb | 3 gp |
| Glue bomb, lesser | Bomb | 3 gp |
...
| Elixir of gender transformation, lesser | Elixir | 1 gp |
| Elixir of life, minor | Elixir | 3 gp |
| Bestial mutagen, lesser | Mutagen | 4 gp |
| Cognitive mutagen, lesser | Mutagen | 4 gp |
| Drakeheart mutagen, lesser | Mutagen | 4 gp |
| Juggernaut mutagen, lesser | Mutagen | 4 gp |
| Quicksilver mutagen, lesser | Mutagen | 4 gp |
| Serene mutagen, lesser | Mutagen | 4 gp |
| Silvertongue mutagen, lesser | Mutagen | 4 gp |
| Arsenic | Poison | 3 gp |
| Giant centipede venom | Poison | 4 gp |
| Forensic dye | Tool | 3 gp |
| Ghost ink | Tool | 3 gp |
| Glow rod | Tool | 3 gp |
| Matchstick | Tool | 2 sp |
| Smoke ball, lesser | Tool | 3 gp |
| Snake oil | Tool | 2 gp |

### 2nd-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Bottled catharsis, minor | Elixir | 5 gp |
...
| Surging serum, minor | Elixir | 5 gp |
| Belladonna | Poison | 5 gp |
| Black adder venom | Poison | 6 gp |
| Lethargy poison (U) | Poison | 7 gp |
| Silver salve | Tool | 6 gp |

### 3rd-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Acid flask, moderate | Bomb | 10 gp |
| Alchemist's fire, moderate | Bomb | 10 gp |
| Blasting stone, moderate | Bomb | 10 gp |
| Blight bomb, moderate | Bomb | 10 gp |
| Bottled lightning, moderate | Bomb | 10 gp |
| Dread ampoule, moderate | Bomb | 10 gp |
| Frost vial, moderate | Bomb | 10 gp |
| Ghost charge, moderate | Bomb | 10 gp |
| Glue bomb, moderate | Bomb | 10 gp |
| Elixir of gender transformation, moderate | Elixir | 8 gp |
| Bestial mutagen, moderate | Mutagen | 12 gp |
| Cognitive mutagen, moderate | Mutagen | 12 gp |
| Drakeheart mutagen, moderate | Mutagen | 12 gp |
| Juggernaut mutagen, moderate | Mutagen | 12 gp |
| Quicksilver mutagen, moderate | Mutagen | 12 gp |
| Serene mutagen, moderate | Mutagen | 12 gp |
| Silvertongue mutagen, moderate | Mutagen | 12 gp |
| Cytillesh oil | Poison | 10 gp |
| Graveroot | Poison | 10 gp |

### 4th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Crystal shards, moderate | Bomb | 16 gp |
| Bomber's eye elixir, lesser | Elixir | 14 gp |
| Bottled catharsis, lesser | Elixir | 15 gp |
| Cooling elixir, lesser | Elixir | 15 gp |
| Darkvision elixir, moderate | Elixir | 11 gp |
| Mistform elixir, lesser | Elixir | 18 gp |
| Stone fist elixir | Elixir | 13 gp |
| Surging serum, lesser | Elixir | 15 gp |
| Witchwarg elixir, lesser | Elixir | 15 gp |
| Fearflower nectar | Poison | 16 gp |
| Leadenleg | Poison | 15 gp |
| Timeless salts | Tool | 14 gp |

### 5th-Level Alchemical Items
...
| Spider venom | Poison | 25 gp |
| Absolute solvent, lesser | Tool | 21 gp |

### 6th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Antidote, moderate | Elixir | 35 gp |
| Antiplague, moderate | Elixir | 35 gp |
| Elixir of gender transformation, greater | Elixir | 35 gp |
| Mistform elixir, moderate | Elixir | 56 gp |
| Giant scorpion venom | Poison | 40 gp |

### 7th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Comprehension elixir, greater | Elixir | 54 gp |
| Tangle root toxin | Poison | 55 gp |
| Everlasting adhesive | Tool | 55 gp |
| Skinstitch salve | Tool | 55 gp |
| Smoke ball, greater | Tool | 53 gp |

### 8th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Bottled catharsis, moderate | Elixir | 75 gp |
| Darkvision elixir, greater | Elixir | 90 gp |
| Surging serum, moderate | Elixir | 75 gp |
| Nettleweed residue | Poison | 75 gp |
| Wyvern poison | Poison | 80 gp |

### 9th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Cheetah's elixir, greater | Elixir | 110 gp |
| Elixir of life, moderate | Elixir | 150 gp |
| Enervating powder | Poison | 110 gp |
| Spider root | Poison | 110 gp |

### 10th-Level Alchemical Items
...
| Nethershade | Poison | 160 gp |
| Wolfsbane | Poison | 155 gp |

### 11th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Acid flask, greater | Bomb | 250 gp |
| Alchemist's fire, greater | Bomb | 250 gp |
| Blasting stone, greater | Bomb | 250 gp |
| Blight bomb, greater | Bomb | 250 gp |
| Bottled lightning, greater | Bomb | 250 gp |
| Dread ampoule, greater | Bomb | 300 gp |
| Frost vial, greater | Bomb | 250 gp |
| Ghost charge, greater | Bomb | 250 gp |
| Glue bomb, greater | Bomb | 250 gp |
| Bestial mutagen, greater | Mutagen | 300 gp |
| Cognitive mutagen, greater | Mutagen | 300 gp |
| Drakeheart mutagen, greater | Mutagen | 300 gp |
| Juggernaut mutagen, greater | Mutagen | 300 gp |
| Quicksilver mutagen, greater | Mutagen | 300 gp |
| Serene mutagen, greater | Mutagen | 300 gp |
| Silvertongue mutagen, greater | Mutagen | 300 gp |
| Blightburn resin | Poison | 225 gp |

### 12th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Crystal shards, greater | Bomb | 350 gp |
| Bottled catharsis, greater | Elixir | 325 gp |
| Cooling elixir, moderate | Elixir | 320 gp |
| Sea touch elixir, moderate | Elixir | 300 gp |
| Surging serum, greater | Elixir | 325 gp |
| Witchwarg elixir, moderate | Elixir | 320 gp |
| Cave worm venom | Poison | 500 gp |
| Slumber wine | Poison | 325 gp |
| Absolute solvent, moderate | Tool | 325 gp |

### 13th-Level Alchemical Items
...
### 16th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Cooling elixir, greater | Elixir | 1,400 gp |
| Eagle-eye elixir, major | Elixir | 2,000 gp |
| Witchwarg elixir, greater | Elixir | 1,400 gp |
| Brimstone fumes | Poison | 1,500 gp |
| Cerulean scourge | Poison | 1,450 gp |

### 17th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Acid flask, major | Bomb | 2,500 gp |
| Alchemist's fire, major | Bomb | 2,500 gp |
| Blasting stone, major | Bomb | 2,500 gp |
| Blight bomb, major | Bomb | 2,500 gp |
| Bottled lightning, major | Bomb | 2,500 gp |
| Dread ampoule, major | Bomb | 3,000 gp |
| Frost vial, major | Bomb | 2,500 gp |
| Ghost charge, major | Bomb | 2,500 gp |
| Glue bomb, major | Bomb | 2,500 gp |
| Bestial mutagen, major | Mutagen | 3,000 gp |
| Cognitive mutagen, major | Mutagen | 3,000 gp |
| Drakeheart mutagen, major | Mutagen | 3,000 gp |
| Juggernaut mutagen, major | Mutagen | 3,000 gp |
| Quicksilver mutagen, major | Mutagen | 3,000 gp |
| Serene mutagen, major | Mutagen | 3,000 gp |
| Silvertongue mutagen, major | Mutagen | 3,000 gp |
| Hemlock | Poison | 2,250 gp |

### 18th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Crystal shards, major | Bomb | 4,000 gp |
| Bottled catharsis, major | Elixir | 3,250 gp |
| Surging serum, major | Elixir | 3,250 gp |
| King's sleep | Poison | 4,000 gp |
| Absolute solvent, greater | Tool | 3,250 gp |

### 19th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Elixir of life, true | Elixir | 8,000 gp |
| Black lotus extract | Poison | 6,500 gp |

### 20th-Level Alchemical Items

| Item | Category | Price |
|------|----------|-------|
| Elixir of rejuvenation (U) | Elixir | — |
| Tears of death | Poison | 12,000 gp |
| Philosopher's stone (U) | Tool | — |
